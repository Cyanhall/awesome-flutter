...
* [Flutter Examples](https://github.com/nisrulz/flutter-examples) ` 🔥 5.3k `  - [Examples] Simple basic isolated apps, for budding flutter devs. ` 📝 13 days ago `
...
* [Flutter Catalog](https://github.com/X-Wei/flutter_catalog) ` 🔥 1.3k `  - An app showcasing Flutter components, with side-by-side source code view. ` 📝 2 days ago `
...
* [Flutter Neumorphic](https://github.com/Idean/Flutter-Neumorphic) ` 🔥 902 `  - A complete, ready to use, Neumorphic ui kit for Flutter,  dark mode compatible ` 📝 3 months ago `
...
* [Typeahead](https://github.com/AbdulRahmanAlHamali/flutter_typeahead) ` 🔥 461 `  - A TypeAhead widget for Flutter, where you can show suggestions to users as they type ` 📝 14 days ago `
...
* [Beautiful_Popup](https://github.com/jaweii/Flutter_beautiful_popup) ` 🔥 341 `  - A flutter package to help you beautify your app popups. ` 📝 a year ago `
...
* [Card Settings](https://github.com/codegrue/card_settings) ` 🔥 236 `  - A flutter package for building card based forms. ` 📝 12 days ago `
...
* [Flutter Tags](https://github.com/Dn-a/flutter_tags) ` 🔥 215 `  - With flutter tags you can create selectable or input tags that automatically adapt to the screen width ` 📝 2 months ago `
...
* [Credit Card Form](https://github.com/Origogi/Flutter-Credit-Card-Input) ` 🔥 186 `  - Flutter Credit Card Input form ` 📝 8 days ago `
...
* #### Sticky Headers [🔝](#readme)
    ...
    * [Sticky Headers](https://github.com/slightfoot/flutter_sticky_headers) ` 🔥 601 `  - Flutter Sticky Headers - Lets you place 'sticky headers' into any scrollable content in your Flutter app. No special wrappers or magic required. Maintainer: @slightfoot ` 📝 a year ago`
    * [Sticky Header](https://github.com/letsar/flutter_sticky_header) ` 🔥 593 `  - Flutter implementation of sticky headers for sliver ` 📝 5 months ago`
...
* #### Drawers [🔝](#readme)
    ...
    * [Flutter Inner Drawer](https://github.com/Dn-a/flutter_inner_drawer) ` 🔥 259 `  - Inner Drawer is an easy way to create an internal side section (left/right) where you can insert a list-menu or other. ` 📝 6 months ago`
...
* #### Bottom Sheets [🔝](#readme)
    ...
    * [Modal Bottom Sheet](https://github.com/jamesblasco/modal_bottom_sheet) ` 🔥 727 `  - Flutter | Create advanced modal bottom sheets. Material, Cupertino or your own style ` 📝 23 days ago`
...
* #### Sliders [🔝](#readme)
    ...
    * [RangeSlider](https://github.com/boeledi/RangeSlider) ` 🔥 251 `  - RangeSlider Widget for Flutter ` 📝 4 months ago`
    * [Flutter Xlider](https://github.com/Ali-Azmoud/flutter_xlider) ` 🔥 247 `  - A material design slider and range slider with rtl support and lots of options and customization for flutter ` 📝 8 months ago`
...
* #### UI Helpers [🔝](#readme)
    ...
    * [ShowCaseView](https://github.com/simformsolutions/flutter_showcaseview) ` 🔥 472 `  - Flutter plugin that allows you to showcase your features on iOS and Android. ` 📝 2 months ago`
...
* #### Cupertino Design [🔝](#readme)
    ...
    * [Peek & Pop](https://github.com/aliyigitbireroglu/flutter-peek-and-pop) ` 🔥 162 `  - Peek & Pop implementation for Flutter based on the iOS functionality of the same name. ` 📝 3 months ago`
...
* #### Calendar [🔝](#readme)
    ...
    * [Calendar Widget](https://github.com/pinkfish/flutter_calendar) ` 🔥 131 `  - Calendar widget for flutter ` 📝 4 days ago`
  
* #### Login [🔝](#readme)

    * [Flutter Login](https://github.com/NearHuscarl/flutter_login) ` 🔥 612 `  - Provides login screen with login/signup functionalities to help speed up development ` 📝 a year ago`
    * [Login Animation](https://github.com/GeekyAnts/flutter-login-home-animation)   
  
* #### Backend-Driven [🔝](#readme)

    * [Dynamic Widget](https://github.com/dengyin2000/dynamic_widget) ` 🔥 808 `  - A Backend-Driven UI toolkit, build your dynamic UI with json, and the json format is very similar with flutter widget code. ` 📝 13 days ago`
...
* [Multi Image Picker](https://github.com/Sh1d0w/multi_image_picker) ` 🔥 864 `  - Flutter plugin that allows you to display multi image picker on iOS and Android. ` 📝 a month ago `
...
* [Crop](https://github.com/xclud/flutter_crop) ` 🔥 96 `  - Crop any widget/image in Android, iOS, Web and Desktop with fancy and customizable UI, in pure Dart code. ` 📝 2 months ago `
* [Bitmap](https://github.com/renancaraujo/bitmap) ` 🔥 95 `  - A Flutter package for manipulating bitmaps ` 📝 2 months ago `
  
* #### Image Picker [🔝](#readme)

    * [WeChat Assets Picker](https://github.com/fluttercandies/flutter_wechat_assets_picker) ` 🔥 361 `  - An assets picker in WeChat style, support multi assets picking. ` 📝 a month ago`
    * [Image Picker](https://github.com/flutter/plugins/tree/master/packages/image_picker)   
  
## Map [🔝](#readme)

* [AMap](https://github.com/fluttify-project/amap_map_fluttify) ` 🔥 470 `  - 高德地图 地图组件 Flutter插件 ` 📝 4 months ago `
...
* [FL Chart](https://github.com/imaNNeoFighT/fl_chart) ` 🔥 2.6k `  - A powerful Flutter chart library, currently supporting Line Chart, Bar Chart, Pie Chart and Scatter Chart. ` 📝 24 days ago `
* [Echarts](https://github.com/entronad/flutter_echarts) ` 🔥 393 `  - A Flutter widget to use Apache ECharts (incubating) in a reactive way. ` 📝 2 months ago `
* [Bezier Chart](https://github.com/aeyrium/bezier-chart) ` 🔥 335 `  - A beautiful bezier line chart widget for flutter that is highly interactive and configurable. ` 📝 3 months ago `
* [Circular Chart](https://github.com/xqwzts/flutter_circular_chart) ` 🔥 325 `  - Animated radial and pie charts for Flutter ` 📝 2 years ago `
* [FCharts](https://github.com/thekeenant/fcharts) ` 🔥 315 `  - [wip] Create beautiful, responsive, animated charts using a simple and intuitive API. ` 📝 2 years ago `
...
* [Graphic](https://github.com/entronad/graphic) ` 🔥 134 `  - A Flutter data visualization library based on Grammar of Graphics. ` 📝 2 months ago `
...
* [Get](https://github.com/jonataslaw/get) ` 🔥 2.2k `  - Open screens/snackbars/dialogs/bottomSheets without context, manage states and inject dependencies easily with Get. ` 📝 11 hours ago `
...
* [Markdown](https://github.com/flutter/flutter_markdown) ` 🔥 761 `  - A markdown renderer for Flutter. ` 📝 21 days ago `
...
* [attranslate](https://github.com/fkirc/attranslate) ` 🔥 157 `  - Semi-automated Text Translator for Websites and Apps ` 📝 16 days ago `
...
* #### Audio [🔝](#readme)
    ...
    * [Flutter Sound](https://github.com/dooboolab/flutter_sound) ` 🔥 496 `  - Flutter plugin for sound. Audio recorder and player. ` 📝 6 days ago`
    * [AssetsAudioPlayer](https://github.com/florent37/Flutter-AssetsAudioPlayer) ` 🔥 418 `  - Play simultaneously music/audio from assets/network/file directly from Flutter, compatible with android / ios / web / macos, displays notifications ` 📝 17 days ago`
...
* #### Video [🔝](#readme)
    ...
    * [CamerAwesome](https://github.com/Apparence-io/camera_awesome) ` 🔥 160 `  - A flutter plugin to handle Android / iOS camera ` 📝 21 days ago`
    * [Video Trimmer](https://github.com/sbis04/video_trimmer) ` 🔥 151 `  - Flutter video trimmer package ` 📝 24 days ago`
...
* [FlutterFoodybite](https://github.com/JideGuru/FlutterFoodybite) ` 🔥 851 `  - Flutter representation of a Restaurant app UI. ` 📝 13 days ago `
...
* [Cupertino Settings](https://github.com/matthinc/flutter_cupertino_settings) ` 🔥 152 `  - A Flutter widget to create an iOS settings-table (static TableView). ` 📝 7 days ago `
...
* [GitTouch](https://github.com/pd4d10/git-touch) ` 🔥 576 `  - An open-source app for GitHub, GitLab, Bitbucket, Gitea, and Gitee(码云), built with Flutter ` 📝 3 days ago `
...
* #### Augmented Reality [🔝](#readme)
    ...
    * [ARKit Plugin](https://github.com/olexale/arkit_flutter_plugin) ` 🔥 506 `  - ARKit Flutter Plugin ` 📝 19 days ago`
...
* [Geolocator](https://github.com/baseflow/flutter-geolocator) ` 🔥 720 `  - Android and iOS Geolocation plugin for Flutter ` 📝 8 days ago `
* [Location](https://github.com/Lyokone/flutterlocation) ` 🔥 682 `  - A Flutter plugin to easily handle realtime location in iOS and Android. Provides settings for optimizing performance or battery. ` 📝 6 days ago `
...
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ` 🔥 479 `  - File picker plugin for Flutter, compatible with both iOS & Android and desktop (go-flutter). ` 📝 17 days ago `
...
* [VPN](https://github.com/X-dea/Flutter_VPN) ` 🔥 146 `  - Plugin to access VPN service for Flutter | Flutter 的 VPN 插件 ` 📝 22 days ago `
...
* #### Bluetooth / NFC / Beacon [🔝](#readme)
    ...
    * [Reactive Ble](https://github.com/PhilipsHue/flutter_reactive_ble) ` 🔥 139 `  - Flutter library that handles BLE operations for multiple devices. ` 📝 9 days ago`
...
* [Sqflite](https://github.com/tekartik/sqflite) ` 🔥 2k `  - SQLite flutter plugin ` 📝 15 days ago `
...
* #### Standard [🔝](#readme)
    ...
    * [RiverPod](https://github.com/rrousselGit/river_pod) ` 🔥 1.1k `  - A simple way to access state while robust and testable. ` 📝 5 days ago`
...
* [Form Builder](https://github.com/danvick/flutter_form_builder) ` 🔥 663 `  - Simple form maker for Flutter Framework ` 📝 22 days ago `
...
* [GeoFlutterFire](https://github.com/DarshanGowda0/GeoFlutterFire) ` 🔥 196 `  - GeoFlutterFire is an open-source library that allows you to store and query firestore documents based on their geographic location. ` 📝 19 days ago `
...
* [AnimatedTextKit](https://github.com/aagarwal1012/Animated-Text-Kit) ` 🔥 922 `  - A flutter package to create cool and beautiful text animations. ` 📝 20 days ago `
...
* [Funvas](https://github.com/creativecreatorormaybenot/funvas) ` 🔥 101 `  - Flutter fun canvas - Flutter package that allows creating canvas animations based on time and math functions. ` 📝 8 days ago `
...
* [Responsive Framework](https://github.com/Codelessly/ResponsiveFramework) ` 🔥 398 `  - Easily make Flutter apps responsive. Automatically adapt UI to different screen sizes. Responsiveness made simple. Demo: https://gallery.codelessly.com/flutterwebsites/minimal/ ` 📝 22 days ago `
...
* [Fwitter](https://github.com/TheAlphamerc/flutter_twitter_clone) ` 🔥 1k `  - Fully functional Twitter clone built in flutter framework using Firebase realtime database and storage ` 📝 3 days ago `
* [GitJournal](https://github.com/GitJournal/GitJournal) ` 🔥 947 `  - Mobile first Note Taking integrated with Git ` 📝 3 days ago `
...
* [Spacex-Go](https://github.com/jesusrp98/spacex-go) ` 🔥 534 `  - Simple yet powerful, open-source SpaceX launch tracker. ` 📝 8 days ago `
...
* [Enhancement_Suite](https://github.com/marius-h/flutter_enhancement_suite) ` 🔥 124 `  - The essential IntelliJ/Android Studio plugin for making working with Flutter easier than ever! ` 📝 16 days ago `
...
* [Raspberry Pi Embedder](https://github.com/ardera/flutter-pi) ` 🔥 437 `  - A light-weight Flutter Engine Embedder for Raspberry Pi that runs without X. ` 📝 4 days ago `
* [bitsdojo_window](https://github.com/bitsdojo/bitsdojo_window) ` 🔥 56 `  - A Flutter package that makes it easy to customize and work with your Flutter desktop app window. ` 📝 22 days ago `
