...
* [Flutter Examples](https://github.com/nisrulz/flutter-examples) ` 🔥 5.3k `  - [Examples] Simple basic isolated apps, for budding flutter devs. ` 📝 18 days ago `
...
* [Flushbar](https://github.com/AndreHaueisen/flushbar) ` 🔥 755 `  - Custom widget for Flutter ` 📝 8 months ago `
...
* [Typeahead](https://github.com/AbdulRahmanAlHamali/flutter_typeahead) ` 🔥 464 `  - A TypeAhead widget for Flutter, where you can show suggestions to users as they type ` 📝 19 days ago `
...
* [Card Settings](https://github.com/codegrue/card_settings) ` 🔥 240 `  - A flutter package for building card based forms. ` 📝 17 days ago `
* [Dough](https://github.com/HatFeather/flutter_dough) ` 🔥 226 `  - This package provides some widgets you can use to create a smooshy UI. ` 📝 2 days ago `
...
* [Credit Card Form](https://github.com/Origogi/Flutter-Credit-Card-Input) ` 🔥 186 `  - Flutter Credit Card Input form ` 📝 13 days ago `
...
* #### Cupertino Design [🔝](#readme)
    ...
    * [Peek & Pop](https://github.com/aliyigitbireroglu/flutter-peek-and-pop) ` 🔥 163 `  - Peek & Pop implementation for Flutter based on the iOS functionality of the same name. ` 📝 3 months ago`
...
* #### Effect [🔝](#readme)
    ...
    * [Wave](https://github.com/i-protoss/wave) ` 🔥 507 `  - Widget for displaying waves with custom color, duration, floating and blur effects. ` 📝 4 months ago`
...
* #### Calendar [🔝](#readme)
    ...
    * [Calendar Widget](https://github.com/pinkfish/flutter_calendar) ` 🔥 133 `  - Calendar widget for flutter ` 📝 9 days ago`
...
* #### Backend-Driven [🔝](#readme)
    ...
    * [Dynamic Widget](https://github.com/dengyin2000/dynamic_widget) ` 🔥 812 `  - A Backend-Driven UI toolkit, build your dynamic UI with json, and the json format is very similar with flutter widget code. ` 📝 4 days ago`
  
## Image [🔝](#readme)

* [Cached Network Image](https://github.com/renefloor/flutter_cached_network_image) ` 🔥 1.6k `  - Download, cache and show images in a flutter app ` 📝 16 days ago `
...
* #### Image Picker [🔝](#readme)
    ...
    * [WeChat Assets Picker](https://github.com/fluttercandies/flutter_wechat_assets_picker) ` 🔥 363 `  - An assets picker in WeChat style, support multi assets picking. ` 📝 3 days ago`
...
* [Echarts](https://github.com/entronad/flutter_echarts) ` 🔥 398 `  - A Flutter widget to use Apache ECharts (incubating) in a reactive way. ` 📝 4 days ago `
...
* [Get](https://github.com/jonataslaw/get) ` 🔥 2.2k `  - Open screens/snackbars/dialogs/bottomSheets without context, manage states and inject dependencies easily with Get. ` 📝 5 days ago `
...
* [Markdown](https://github.com/flutter/flutter_markdown) ` 🔥 765 `  - A markdown renderer for Flutter. ` 📝 2 days ago `
...
* [attranslate](https://github.com/fkirc/attranslate) ` 🔥 159 `  - Semi-automated Text Translator for Websites and Apps ` 📝 21 days ago `
...
* #### Audio [🔝](#readme)
    ...
    * [Flutter Sound](https://github.com/dooboolab/flutter_sound) ` 🔥 499 `  - Flutter plugin for sound. Audio recorder and player. ` 📝 11 days ago`
    * [AssetsAudioPlayer](https://github.com/florent37/Flutter-AssetsAudioPlayer) ` 🔥 425 `  - Play simultaneously music/audio from assets/network/file directly from Flutter, compatible with android / ios / web / macos, displays notifications ` 📝 10 hours ago`
...
* [FlutterFoodybite](https://github.com/JideGuru/FlutterFoodybite) ` 🔥 853 `  - Flutter representation of a Restaurant app UI. ` 📝 18 days ago `
...
* [Smart Washing Machine](https://github.com/pawlik92/flutter_whirlpool) ` 🔥 417 `  - Flutter UI challenge (with Box2D physic)- Smart washing machine app ` 📝 8 months ago `
...
* [Cupertino Settings](https://github.com/matthinc/flutter_cupertino_settings) ` 🔥 153 `  - A Flutter widget to create an iOS settings-table (static TableView). ` 📝 12 days ago `
...
* [GitTouch](https://github.com/pd4d10/git-touch) ` 🔥 582 `  - An open-source app for GitHub, GitLab, Bitbucket, Gitea, and Gitee(码云), built with Flutter ` 📝 4 days ago `
...
* #### Augmented Reality [🔝](#readme)
    ...
    * [ARKit Plugin](https://github.com/olexale/arkit_flutter_plugin) ` 🔥 507 `  - ARKit Flutter Plugin ` 📝 24 days ago`
...
* [Geolocator](https://github.com/baseflow/flutter-geolocator) ` 🔥 724 `  - Android and iOS Geolocation plugin for Flutter ` 📝 13 days ago `
* [Location](https://github.com/Lyokone/flutterlocation) ` 🔥 684 `  - A Flutter plugin to easily handle realtime location in iOS and Android. Provides settings for optimizing performance or battery. ` 📝 11 days ago `
...
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ` 🔥 483 `  - File picker plugin for Flutter, compatible with both iOS & Android and desktop (go-flutter). ` 📝 22 days ago `
...
* #### Bluetooth / NFC / Beacon [🔝](#readme)
    ...
    * [Beacon broadcast](https://github.com/pszklarska/beacon_broadcast) ` 🔥 65 `  - A Flutter plugin for turning your device into a beacon. ` 📝 25 days ago`
...
* #### Standard [🔝](#readme)
    ...
    * [GetX](https://github.com/jonataslaw/getx) ` 🔥 2.2k `  - Open screens/snackbars/dialogs/bottomSheets without context, manage states and inject dependencies easily with Get. ` 📝 5 days ago`
...
* #### Redux / ELM / Dependency Injection [🔝](#readme)
    ...
    * [Redux](https://github.com/brianegan/flutter_redux) ` 🔥 1.4k `  - A library that connects Widgets to a Redux Store ` 📝 4 days ago`
...
* [Form Builder](https://github.com/danvick/flutter_form_builder) ` 🔥 668 `  - Simple form maker for Flutter Framework ` 📝 4 days ago `
...
* [GeoFlutterFire](https://github.com/DarshanGowda0/GeoFlutterFire) ` 🔥 197 `  - GeoFlutterFire is an open-source library that allows you to store and query firestore documents based on their geographic location. ` 📝 24 days ago `
...
* [AnimatedTextKit](https://github.com/aagarwal1012/Animated-Text-Kit) ` 🔥 927 `  - A flutter package to create cool and beautiful text animations. ` 📝 25 days ago `
...
* [Simple Animations](https://github.com/felixblaschke/simple_animations) ` 🔥 557 `  - Flutter package for creating awesome animations. ` 📝 9 days ago `
...
* [Funvas](https://github.com/creativecreatorormaybenot/funvas) ` 🔥 102 `  - Flutter fun canvas - Flutter package that allows creating canvas animations based on time and math functions. ` 📝 13 days ago `
...
* [AspectD](https://github.com/alibaba-flutter/aspectd) ` 🔥 776 `  - AOP for Flutter(Dart) ` 📝 4 days ago `
...
* [Fwitter](https://github.com/TheAlphamerc/flutter_twitter_clone) ` 🔥 1k `  - Fully functional Twitter clone built in flutter framework using Firebase realtime database and storage ` 📝 8 days ago `
* [GitJournal](https://github.com/GitJournal/GitJournal) ` 🔥 968 `  - Mobile first Note Taking integrated with Git ` 📝 4 days ago `
...
* [Spacex-Go](https://github.com/jesusrp98/spacex-go) ` 🔥 536 `  - Simple yet powerful, open-source SpaceX launch tracker. ` 📝 7 days ago `
...
* [FlutterGen](https://github.com/FlutterGen/flutter_gen) ` 🔥 554 `  - The Flutter code generator for your assets, fonts, colors, … — Get rid of all String-based APIs. ` 📝 9 days ago `
...
* [Enhancement_Suite](https://github.com/marius-h/flutter_enhancement_suite) ` 🔥 126 `  - The essential IntelliJ/Android Studio plugin for making working with Flutter easier than ever! ` 📝 21 days ago `
...
* [Raspberry Pi Embedder](https://github.com/ardera/flutter-pi) ` 🔥 446 `  - A light-weight Flutter Engine Embedder for Raspberry Pi that runs without X. ` 📝 9 days ago `
