...
* [Flutter Examples](https://github.com/nisrulz/flutter-examples) ` 🔥 5.3k `  - [Examples] Simple basic isolated apps, for budding flutter devs. ` 📝 17 days ago `
...
* [Typeahead](https://github.com/AbdulRahmanAlHamali/flutter_typeahead) ` 🔥 464 `  - A TypeAhead widget for Flutter, where you can show suggestions to users as they type ` 📝 18 days ago `
...
* [Card Settings](https://github.com/codegrue/card_settings) ` 🔥 240 `  - A flutter package for building card based forms. ` 📝 16 days ago `
* [Dough](https://github.com/HatFeather/flutter_dough) ` 🔥 226 `  - This package provides some widgets you can use to create a smooshy UI. ` 📝 a day ago `
...
* [Credit Card Form](https://github.com/Origogi/Flutter-Credit-Card-Input) ` 🔥 186 `  - Flutter Credit Card Input form ` 📝 12 days ago `
...
* #### Effect [🔝](#readme)
    ...
    * [Shimmer](https://github.com/hnvn/flutter_shimmer) ` 🔥 1.2k `  - A package provides an easy way to add shimmer effect in Flutter project ` 📝 5 days ago`
...
* #### Calendar [🔝](#readme)
    ...
    * [Calendar Widget](https://github.com/pinkfish/flutter_calendar) ` 🔥 133 `  - Calendar widget for flutter ` 📝 8 days ago`
...
* #### Backend-Driven [🔝](#readme)
    ...
    * [Dynamic Widget](https://github.com/dengyin2000/dynamic_widget) ` 🔥 812 `  - A Backend-Driven UI toolkit, build your dynamic UI with json, and the json format is very similar with flutter widget code. ` 📝 3 days ago`
  
## Image [🔝](#readme)

* [Cached Network Image](https://github.com/renefloor/flutter_cached_network_image) ` 🔥 1.6k `  - Download, cache and show images in a flutter app ` 📝 15 days ago `
...
* #### Image Picker [🔝](#readme)
    ...
    * [WeChat Assets Picker](https://github.com/fluttercandies/flutter_wechat_assets_picker) ` 🔥 363 `  - An assets picker in WeChat style, support multi assets picking. ` 📝 2 days ago`
...
* [Echarts](https://github.com/entronad/flutter_echarts) ` 🔥 398 `  - A Flutter widget to use Apache ECharts (incubating) in a reactive way. ` 📝 3 days ago `
...
* [Login](https://github.com/AppleEducate/flutter_login) ` 🔥 574 `  - 100% Shared Code Android/iOS Login Example - JSON API ` 📝 8 months ago `
* [Facebook Login](https://github.com/roughike/flutter_facebook_login) ` 🔥 385 `  - A Flutter plugin for allowing users to authenticate with native Android & iOS Facebook login SDKs. ` 📝 5 months ago `
* [SimpleAuth](https://github.com/Clancey/simple_auth) ` 🔥 271 `  - The Simplest way to Authenticate in Flutter ` 📝 7 months ago `
...
* [Markdown](https://github.com/flutter/flutter_markdown) ` 🔥 763 `  - A markdown renderer for Flutter. ` 📝 3 days ago `
...
* [Parsed Text](https://github.com/fayeed/flutter_parsed_text) ` 🔥 125 `  - A Flutter package to parse text and make them into linkified text widget ` 📝 4 months ago `
...
* [attranslate](https://github.com/fkirc/attranslate) ` 🔥 157 `  - Semi-automated Text Translator for Websites and Apps ` 📝 20 days ago `
...
* #### Audio [🔝](#readme)
    ...
    * [Flutter Sound](https://github.com/dooboolab/flutter_sound) ` 🔥 497 `  - Flutter plugin for sound. Audio recorder and player. ` 📝 10 days ago`
    * [AssetsAudioPlayer](https://github.com/florent37/Flutter-AssetsAudioPlayer) ` 🔥 422 `  - Play simultaneously music/audio from assets/network/file directly from Flutter, compatible with android / ios / web / macos, displays notifications ` 📝 21 days ago`
...
* #### Video [🔝](#readme)
    ...
    * [CamerAwesome](https://github.com/Apparence-io/camera_awesome) ` 🔥 161 `  - A flutter plugin to handle Android / iOS camera ` 📝 25 days ago`
...
* [Secure Storage](https://github.com/mogol/flutter_secure_storage) ` 🔥 563 `  - A Flutter plugin to store data in secure storage ` 📝 2 months ago `
...
* [Inapp Purchase](https://github.com/dooboolab/flutter_inapp_purchase) ` 🔥 400 `  - (Sun Rised!) Flutter plugin for In App Purchase. ` 📝 2 months ago `
...
* [FlutterFoodybite](https://github.com/JideGuru/FlutterFoodybite) ` 🔥 853 `  - Flutter representation of a Restaurant app UI. ` 📝 17 days ago `
...
* [Cupertino Settings](https://github.com/matthinc/flutter_cupertino_settings) ` 🔥 153 `  - A Flutter widget to create an iOS settings-table (static TableView). ` 📝 11 days ago `
...
* [GitTouch](https://github.com/pd4d10/git-touch) ` 🔥 582 `  - An open-source app for GitHub, GitLab, Bitbucket, Gitea, and Gitee(码云), built with Flutter ` 📝 3 days ago `
...
* #### Augmented Reality [🔝](#readme)
    ...
    * [ARKit Plugin](https://github.com/olexale/arkit_flutter_plugin) ` 🔥 507 `  - ARKit Flutter Plugin ` 📝 23 days ago`
...
* [Geolocator](https://github.com/baseflow/flutter-geolocator) ` 🔥 724 `  - Android and iOS Geolocation plugin for Flutter ` 📝 12 days ago `
* [Location](https://github.com/Lyokone/flutterlocation) ` 🔥 684 `  - A Flutter plugin to easily handle realtime location in iOS and Android. Provides settings for optimizing performance or battery. ` 📝 10 days ago `
...
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ` 🔥 483 `  - File picker plugin for Flutter, compatible with both iOS & Android and desktop (go-flutter). ` 📝 21 days ago `
...
* #### Bluetooth / NFC / Beacon [🔝](#readme)
    ...
    * [Beacon broadcast](https://github.com/pszklarska/beacon_broadcast) ` 🔥 65 `  - A Flutter plugin for turning your device into a beacon. ` 📝 24 days ago`
...
* #### Redux / ELM / Dependency Injection [🔝](#readme)
    ...
    * [Redux](https://github.com/brianegan/flutter_redux) ` 🔥 1.4k `  - A library that connects Widgets to a Redux Store ` 📝 3 days ago`
...
* [Form Builder](https://github.com/danvick/flutter_form_builder) ` 🔥 668 `  - Simple form maker for Flutter Framework ` 📝 3 days ago `
...
* [GeoFlutterFire](https://github.com/DarshanGowda0/GeoFlutterFire) ` 🔥 197 `  - GeoFlutterFire is an open-source library that allows you to store and query firestore documents based on their geographic location. ` 📝 23 days ago `
...
* [AnimatedTextKit](https://github.com/aagarwal1012/Animated-Text-Kit) ` 🔥 925 `  - A flutter package to create cool and beautiful text animations. ` 📝 24 days ago `
...
* [Simple Animations](https://github.com/felixblaschke/simple_animations) ` 🔥 551 `  - Flutter package for creating awesome animations. ` 📝 8 days ago `
...
* [Funvas](https://github.com/creativecreatorormaybenot/funvas) ` 🔥 102 `  - Flutter fun canvas - Flutter package that allows creating canvas animations based on time and math functions. ` 📝 12 days ago `
...
* [AspectD](https://github.com/alibaba-flutter/aspectd) ` 🔥 776 `  - AOP for Flutter(Dart) ` 📝 3 days ago `
...
* [Fwitter](https://github.com/TheAlphamerc/flutter_twitter_clone) ` 🔥 1k `  - Fully functional Twitter clone built in flutter framework using Firebase realtime database and storage ` 📝 7 days ago `
* [GitJournal](https://github.com/GitJournal/GitJournal) ` 🔥 968 `  - Mobile first Note Taking integrated with Git ` 📝 3 days ago `
...
* [Spacex-Go](https://github.com/jesusrp98/spacex-go) ` 🔥 536 `  - Simple yet powerful, open-source SpaceX launch tracker. ` 📝 6 days ago `
...
* [FlutterGen](https://github.com/FlutterGen/flutter_gen) ` 🔥 554 `  - The Flutter code generator for your assets, fonts, colors, … — Get rid of all String-based APIs. ` 📝 8 days ago `
...
* [Enhancement_Suite](https://github.com/marius-h/flutter_enhancement_suite) ` 🔥 126 `  - The essential IntelliJ/Android Studio plugin for making working with Flutter easier than ever! ` 📝 20 days ago `
...
* [Golang Desktop Embedder](https://github.com/go-flutter-desktop/go-flutter) ` 🔥 4.6k `  - Flutter on Windows, MacOS and Linux - based on Flutter Embedding, Go and GLFW. ` 📝 5 days ago `
...
* [Raspberry Pi Embedder](https://github.com/ardera/flutter-pi) ` 🔥 446 `  - A light-weight Flutter Engine Embedder for Raspberry Pi that runs without X. ` 📝 8 days ago `
