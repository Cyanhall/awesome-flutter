...
* [Roadmap to Flutter Development](https://github.com/olexale/flutter_roadmap) ` 🔥 2k `  - Highly Subjective Roadmap to Flutter Development ` 📝 17 days ago `
...
* [Official Gallery](https://github.com/flutter/gallery) ` 🔥 2.5k `  - Flutter Gallery is a resource to help developers evaluate and use Flutter ` 📝 12 days ago `
* [Flutter Catalog](https://github.com/X-Wei/flutter_catalog) ` 🔥 1.5k `  - An app showcasing Flutter components, with side-by-side source code view. ` 📝 9 days ago `
...
* [Direct Select](https://github.com/LanarsInc/direct-select-flutter) ` 🔥 404 `  - DirectSelect is a selection widget with an ethereal, full-screen modal popup displaying the available choices when the widget is interact with. https://dribbble.com/shots/3876250-DirectSelect-Dropdown-ux ` 📝 22 days ago `
...
* [Card Settings](https://github.com/codegrue/card_settings) ` 🔥 282 `  - A flutter package for building card based forms. ` 📝 14 days ago `
...
* [Scratcher](https://github.com/vintage/scratcher) ` 🔥 253 `  - Scratch card widget which temporarily hides content from user. ` 📝 21 days ago `
...
* #### UI Helpers [🔝](#readme)
    ...
    * [ShowCaseView](https://github.com/simformsolutions/flutter_showcaseview) ` 🔥 552 `  - Flutter plugin that allows you to showcase your features on iOS and Android. ` 📝 7 days ago`
...
* #### Effect [🔝](#readme)
    ...
    * [Liquid Swipe](https://github.com/iamSahdeep/liquid_swipe_flutter) ` 🔥 739 `  - A flutter based liquid swipe ` 📝 10 days ago`
...
* #### Login [🔝](#readme)
    ...
    * [Flutter Login](https://github.com/NearHuscarl/flutter_login) ` 🔥 769 `  - Provides login screen with login/signup functionalities to help speed up development ` 📝 5 days ago`
...
* [Multi Image Picker](https://github.com/Sh1d0w/multi_image_picker) ` 🔥 903 `  - Flutter plugin that allows you to display multi image picker on iOS and Android. ` 📝 24 days ago `
...
* [Crop](https://github.com/xclud/flutter_crop) ` 🔥 123 `  - Crop any widget/image in Android, iOS, Web and Desktop with fancy and customizable UI, in pure Dart code. ` 📝 8 days ago `
* [Bitmap](https://github.com/renancaraujo/bitmap) ` 🔥 109 `  - A Flutter package for manipulating bitmaps ` 📝 3 months ago `
  
* #### Image Picker [🔝](#readme)

    * [WeChat Assets Picker](https://github.com/fluttercandies/flutter_wechat_assets_picker) ` 🔥 566 `  - An assets picker in WeChat style, support multi assets picking. ` 📝 11 days ago`
...
* [Flutter AppAuth](https://github.com/MaikuB/flutter_appauth) ` 🔥 154 `  - A Flutter wrapper for AppAuth iOS and Android SDKs ` 📝 4 days ago `
...
* [Parsed Text](https://github.com/fayeed/flutter_parsed_text) ` 🔥 157 `  - A Flutter package to parse text and make them into linkified text widget ` 📝 7 days ago `
...
* [attranslate](https://github.com/fkirc/attranslate) ` 🔥 206 `  - Semi-automated Text Translator for Websites and Apps ` 📝 4 days ago `
...
* #### Audio [🔝](#readme)
    ...
    * [Flutter Sound](https://github.com/dooboolab/flutter_sound) ` 🔥 560 `  - Flutter plugin for sound. Audio recorder and player. ` 📝 16 days ago`
...
* #### Video [🔝](#readme)
    ...
    * [CamerAwesome](https://github.com/Apparence-io/camera_awesome) ` 🔥 222 `  - A flutter plugin to handle Android / iOS camera ` 📝 5 days ago`
    * [Video Trimmer](https://github.com/sbis04/video_trimmer) ` 🔥 208 `  - Flutter video trimmer package ` 📝 12 days ago`
...
* [Square In-App Payments SDK](https://github.com/square/in-app-payments-flutter-plugin) ` 🔥 267 `  - Flutter Plugin for Square In-App Payments SDK ` 📝 5 days ago `
* [Facebook Audience Network](https://github.com/dreamsoftin/facebook_audience_network) ` 🔥 127 `  - Flutter Facebook Audience Network ` 📝 9 days ago `
...
* [ActingWeb First_App](https://github.com/gregertw/actingweb_firstapp) ` 🔥 247 `  - Starter app for Flutter that includes many different production app features; some not typically included in demo apps. ` 📝 2 days ago `
...
* [GitTouch](https://github.com/pd4d10/git-touch) ` 🔥 759 `  - An open-source app for GitHub, GitLab, Bitbucket, Gitea, and Gitee(码云), built with Flutter ` 📝 8 days ago `
...
* #### Augmented Reality [🔝](#readme)
    ...
    * [ARKit Plugin](https://github.com/olexale/arkit_flutter_plugin) ` 🔥 540 `  - ARKit Flutter Plugin ` 📝 3 days ago`
    * [ARCore Plugin](https://github.com/giandifra/arcore_flutter_plugin) ` 🔥 273 `  - Flutter plugin for ARCore SDK, Android platform to build new augmented reality experiences ` 📝 24 days ago`
...
* [WebView](https://github.com/dart-flitter/flutter_webview_plugin) ` 🔥 1.3k `  - Community WebView Plugin - Allows Flutter to communicate with a native WebView. ` 📝 15 days ago `
...
* [Location](https://github.com/Lyokone/flutterlocation) ` 🔥 744 `  - A Flutter plugin to easily handle realtime location in iOS and Android. Provides settings for optimizing performance or battery. ` 📝 2 days ago `
* [Downloader](https://github.com/hnvn/flutter_downloader) ` 🔥 567 `  - Flutter Downloader - A plugin for creating and managing download tasks. Supports iOS and Android. Maintainer: @hnvn ` 📝 10 days ago `
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ` 🔥 565 `  - File picker plugin for Flutter, compatible with both iOS & Android and desktop (go-flutter). ` 📝 13 days ago `
...
* #### Scanner [🔝](#readme)
    ...
    * [QR Code Reader](https://github.com/villela/flutter_qrcode_reader) ` 🔥 213 `  - Flutter qrcode reader ` 📝 8 days ago`
...
* #### Bluetooth / NFC / Beacon [🔝](#readme)
    ...
    * [Reactive Ble](https://github.com/PhilipsHue/flutter_reactive_ble) ` 🔥 185 `  - Flutter library that handles BLE operations for multiple devices. ` 📝 9 days ago`
...
* [OneSignal](https://github.com/OneSignal/OneSignal-Flutter-SDK) ` 🔥 446 `  - OneSignal is a free push notification service for mobile apps. This plugin makes it easy to integrate your flutter app with OneSignal ` 📝 3 days ago `
...
* [Form Builder](https://github.com/danvick/flutter_form_builder) ` 🔥 777 `  - Simple form maker for Flutter Framework ` 📝 19 days ago `
...
* [Graphql](https://github.com/zino-app/graphql-flutter) ` 🔥 2.6k `  - A GraphQL client for Flutter, bringing all the features from a modern GraphQL client to one easy to use package. ` 📝 10 days ago `
...
* [Ferry](https://github.com/gql-dart/ferry) ` 🔥 193 `  - Stream-based strongly typed GraphQL client for Dart ` 📝 6 days ago `
...
* [Funvas](https://github.com/creativecreatorormaybenot/funvas) ` 🔥 222 `  - Fun canvas animations in Flutter based on time and math functions. ` 📝 2 days ago `
...
* [Graphx](https://github.com/roipeker/graphx) ` 🔥 244 `  - GraphX lib for Flutter ` 📝 7 days ago `
...
* #### Open source games [🔝](#readme)
    ...
    * [Slide Puzzle](https://github.com/kevmoo/slide_puzzle) ` 🔥 128 `  - The classic slide (15) puzzle in Dart and Flutter ` 📝 7 days ago`
...
* [AuthPass](https://github.com/authpass/authpass) ` 🔥 659 `  - AuthPass - Password Manager based on Flutter for all platforms. Keepass 2.x (kdbx 3.x) compatible. ` 📝 15 days ago `
...
* [Harpy](https://github.com/robertodoering/harpy) ` 🔥 426 `  - A Twitter app built with Flutter ` 📝 2 days ago `
...
* [Very Good Cli](https://github.com/VeryGoodOpenSource/very_good_cli) ` 🔥 775 `  - A Very Good Command Line Interface for Dart created by Very Good Ventures ` 📝 10 days ago `
* [FlutterGen](https://github.com/FlutterGen/flutter_gen) ` 🔥 640 `  - The Flutter code generator for your assets, fonts, colors, … — Get rid of all String-based APIs. ` 📝 9 days ago `
