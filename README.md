...
* [Roadmap to Flutter Development](https://github.com/olexale/flutter_roadmap) ` 🔥 2k `  - Highly Subjective Roadmap to Flutter Development ` 📝 14 days ago `
...
* [Official Gallery](https://github.com/flutter/gallery) ` 🔥 2.5k `  - Flutter Gallery is a resource to help developers evaluate and use Flutter ` 📝 9 days ago `
* [Flutter Catalog](https://github.com/X-Wei/flutter_catalog) ` 🔥 1.5k `  - An app showcasing Flutter components, with side-by-side source code view. ` 📝 6 days ago `
...
* [Direct Select](https://github.com/LanarsInc/direct-select-flutter) ` 🔥 400 `  - DirectSelect is a selection widget with an ethereal, full-screen modal popup displaying the available choices when the widget is interact with. https://dribbble.com/shots/3876250-DirectSelect-Dropdown-ux ` 📝 19 days ago `
...
* [Card Settings](https://github.com/codegrue/card_settings) ` 🔥 279 `  - A flutter package for building card based forms. ` 📝 11 days ago `
...
* [Scratcher](https://github.com/vintage/scratcher) ` 🔥 250 `  - Scratch card widget which temporarily hides content from user. ` 📝 18 days ago `
...
* #### UI Helpers [🔝](#readme)
    ...
    * [ShowCaseView](https://github.com/simformsolutions/flutter_showcaseview) ` 🔥 552 `  - Flutter plugin that allows you to showcase your features on iOS and Android. ` 📝 4 days ago`
...
* #### Material Design [🔝](#readme)
    ...
    * [Slidable](https://github.com/letsar/flutter_slidable) ` 🔥 1.8k `  - A Flutter implementation of slidable list item with directional slide actions. ` 📝 23 days ago`
...
* #### Effect [🔝](#readme)
    ...
    * [Liquid Swipe](https://github.com/iamSahdeep/liquid_swipe_flutter) ` 🔥 739 `  - A flutter based liquid swipe ` 📝 7 days ago`
...
* #### Login [🔝](#readme)
    ...
    * [Flutter Login](https://github.com/NearHuscarl/flutter_login) ` 🔥 769 `  - Provides login screen with login/signup functionalities to help speed up development ` 📝 2 days ago`
...
* [Multi Image Picker](https://github.com/Sh1d0w/multi_image_picker) ` 🔥 903 `  - Flutter plugin that allows you to display multi image picker on iOS and Android. ` 📝 21 days ago `
...
* [Crop](https://github.com/xclud/flutter_crop) ` 🔥 123 `  - Crop any widget/image in Android, iOS, Web and Desktop with fancy and customizable UI, in pure Dart code. ` 📝 5 days ago `
* [Bitmap](https://github.com/renancaraujo/bitmap) ` 🔥 109 `  - A Flutter package for manipulating bitmaps ` 📝 3 months ago `
  
* #### Image Picker [🔝](#readme)

    * [WeChat Assets Picker](https://github.com/fluttercandies/flutter_wechat_assets_picker) ` 🔥 566 `  - An assets picker in WeChat style, support multi assets picking. ` 📝 8 days ago`
...
* [FL Chart](https://github.com/imaNNeoFighT/fl_chart) ` 🔥 3.1k `  - A powerful Flutter chart library, currently supporting Line Chart, Bar Chart, Pie Chart, Scatter Chart and Radar Chart. ` 📝 9 days ago `
...
* [Candlesticks](https://github.com/trentpiercy/flutter-candlesticks) ` 🔥 334 `  - Elegant OHLC Candlestick and Trade Volume charts for @flutter ` 📝 24 days ago `
...
* [Flutter AppAuth](https://github.com/MaikuB/flutter_appauth) ` 🔥 152 `  - A Flutter wrapper for AppAuth iOS and Android SDKs ` 📝 3 months ago `
...
* [Code Field](https://github.com/BertrandBev/code_field) ` 🔥 52 `  - A customizable code text field supporting syntax highlighting ` 📝 13 days ago `
...
* #### Audio [🔝](#readme)
    ...
    * [Flutter Sound](https://github.com/dooboolab/flutter_sound) ` 🔥 559 `  - Flutter plugin for sound. Audio recorder and player. ` 📝 13 days ago`
...
* #### Video [🔝](#readme)
    ...
    * [CamerAwesome](https://github.com/Apparence-io/camera_awesome) ` 🔥 219 `  - A flutter plugin to handle Android / iOS camera ` 📝 9 days ago`
    * [Video Trimmer](https://github.com/sbis04/video_trimmer) ` 🔥 205 `  - Flutter video trimmer package ` 📝 9 days ago`
...
* [Square In-App Payments SDK](https://github.com/square/in-app-payments-flutter-plugin) ` 🔥 267 `  - Flutter Plugin for Square In-App Payments SDK ` 📝 16 days ago `
* [Facebook Audience Network](https://github.com/dreamsoftin/facebook_audience_network) ` 🔥 127 `  - Flutter Facebook Audience Network ` 📝 6 days ago `
...
* [ActingWeb First_App](https://github.com/gregertw/actingweb_firstapp) ` 🔥 244 `  - Starter app for Flutter that includes many different production app features; some not typically included in demo apps. ` 📝 12 days ago `
...
* [GitTouch](https://github.com/pd4d10/git-touch) ` 🔥 753 `  - An open-source app for GitHub, GitLab, Bitbucket, Gitea, and Gitee(码云), built with Flutter ` 📝 5 days ago `
  
## Machine Learning [🔝](#readme)

* [m2gen](https://github.com/BayesWitnesses/m2cgen) ` 🔥 1.8k ` ` 🌐 6 ` - Transform ML models into a native code (Java, C, Python, Go, JavaScript, Visual Basic, C#, R, PowerShell, PHP, Dart, Haskell, Ruby) with zero dependencies ` 📝 18 days ago `
* [MLKit](https://github.com/azihsoyn/flutter_mlkit) ` 🔥 361 `  - A Flutter plugin to use the Firebase ML Kit. ` 📝 10 months ago `
...
* #### Augmented Reality [🔝](#readme)
    ...
    * [ARKit Plugin](https://github.com/olexale/arkit_flutter_plugin) ` 🔥 540 `  - ARKit Flutter Plugin ` 📝 14 days ago`
    * [ARCore Plugin](https://github.com/giandifra/arcore_flutter_plugin) ` 🔥 269 `  - Flutter plugin for ARCore SDK, Android platform to build new augmented reality experiences ` 📝 21 days ago`
...
* [WebView](https://github.com/dart-flitter/flutter_webview_plugin) ` 🔥 1.3k `  - Community WebView Plugin - Allows Flutter to communicate with a native WebView. ` 📝 12 days ago `
...
* [Geolocator](https://github.com/baseflow/flutter-geolocator) ` 🔥 800 `  - Android and iOS Geolocation plugin for Flutter ` 📝 25 days ago `
* [Location](https://github.com/Lyokone/flutterlocation) ` 🔥 742 `  - A Flutter plugin to easily handle realtime location in iOS and Android. Provides settings for optimizing performance or battery. ` 📝 a month ago `
* [Downloader](https://github.com/hnvn/flutter_downloader) ` 🔥 567 `  - Flutter Downloader - A plugin for creating and managing download tasks. Supports iOS and Android. Maintainer: @hnvn ` 📝 7 days ago `
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ` 🔥 559 `  - File picker plugin for Flutter, compatible with both iOS & Android and desktop (go-flutter). ` 📝 10 days ago `
...
* #### Scanner [🔝](#readme)
    ...
    * [QR Code Reader](https://github.com/villela/flutter_qrcode_reader) ` 🔥 213 `  - Flutter qrcode reader ` 📝 5 days ago`
...
* #### Bluetooth / NFC / Beacon [🔝](#readme)
    ...
    * [NFC Manager](https://github.com/okadan/flutter-nfc-manager) ` 🔥 55 `  - Flutter plugin for accessing the NFC features on Android and iOS. ` 📝 9 days ago`
...
* #### Standard [🔝](#readme)
    ...
    * [RiverPod](https://github.com/rrousselGit/river_pod) ` 🔥 1.6k `  - A simple way to access state while robust and testable. ` 📝 19 days ago`
...
* [Hooks](https://github.com/rrousselGit/flutter_hooks) ` 🔥 1.7k `  - React hooks for Flutter. Hooks are a new kind of object that manages a Widget life-cycles. They are used to increase code sharing between widgets and as a complete replacement for StatefulWidget. ` 📝 23 days ago `
* [Form Builder](https://github.com/danvick/flutter_form_builder) ` 🔥 768 `  - Simple form maker for Flutter Framework ` 📝 16 days ago `
...
* [Ferry](https://github.com/gql-dart/ferry) ` 🔥 190 `  - Stream-based strongly typed GraphQL client for Dart ` 📝 5 days ago `
...
* [Funvas](https://github.com/creativecreatorormaybenot/funvas) ` 🔥 217 `  - Fun canvas animations in Flutter based on time and math functions. ` 📝 23 days ago `
* [Animate Do](https://pub.dev/packages/animate_do)   
  
## Testing [🔝](#readme)

* [Flutter Gherkin](https://github.com/jonsamwell/flutter_gherkin) ` 🔥 130 `  - A Gherkin parsers and runner for Dart and Flutter which is very similar to cucumber ` 📝 11 days ago `
...
* [Flame](https://github.com/flame-engine/flame) ` 🔥 4.4k `  - A minimalist Flutter game engine ` 📝 6 days ago `
...
* #### Open source games [🔝](#readme)
    ...
    * [Slide Puzzle](https://github.com/kevmoo/slide_puzzle) ` 🔥 126 `  - The classic slide (15) puzzle in Dart and Flutter ` 📝 4 days ago`
...
* [Flutter Team Samples](https://github.com/flutter/samples) ` 🔥 9.9k `  - A collection of Flutter examples and demos. ` 📝 10 days ago `
...
* [Fwitter](https://github.com/TheAlphamerc/flutter_twitter_clone) ` 🔥 1.3k `  - Fully functional Twitter clone built in flutter framework using Firebase realtime database and storage ` 📝 6 days ago `
...
* [AuthPass](https://github.com/authpass/authpass) ` 🔥 655 `  - AuthPass - Password Manager based on Flutter for all platforms. Keepass 2.x (kdbx 3.x) compatible. ` 📝 12 days ago `
...
* [Harpy](https://github.com/robertodoering/harpy) ` 🔥 414 `  - A Twitter app built with Flutter ` 📝 11 days ago `
...
* [FVM](https://github.com/leoafarias/fvm) ` 🔥 1.7k `  - Flutter Version Management: A simple CLI to manage Flutter SDK versions. ` 📝 10 days ago `
...
* [Very Good Cli](https://github.com/VeryGoodOpenSource/very_good_cli) ` 🔥 769 `  - A Very Good Command Line Interface for Dart created by Very Good Ventures ` 📝 7 days ago `
* [FlutterGen](https://github.com/FlutterGen/flutter_gen) ` 🔥 635 `  - The Flutter code generator for your assets, fonts, colors, … — Get rid of all String-based APIs. ` 📝 6 days ago `
...
* [Raspberry Pi Embedder](https://github.com/ardera/flutter-pi) ` 🔥 595 `  - A light-weight Flutter Engine Embedder for Raspberry Pi that runs without X. ` 📝 7 days ago `
