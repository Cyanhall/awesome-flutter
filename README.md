...
* [Roadmap to Flutter Development](https://github.com/olexale/flutter_roadmap) ` 🔥 2k `  - Highly Subjective Roadmap to Flutter Development ` 📝 23 days ago `
...
* [Official Gallery](https://github.com/flutter/gallery) ` 🔥 2.5k `  - Flutter Gallery is a resource to help developers evaluate and use Flutter ` 📝 18 days ago `
* [Flutter Catalog](https://github.com/X-Wei/flutter_catalog) ` 🔥 1.5k `  - An app showcasing Flutter components, with side-by-side source code view. ` 📝 15 days ago `
...
* [Card Settings](https://github.com/codegrue/card_settings) ` 🔥 284 `  - A flutter package for building card based forms. ` 📝 2 days ago `
...
* #### UI Helpers [🔝](#readme)
    ...
    * [ShowCaseView](https://github.com/simformsolutions/flutter_showcaseview) ` 🔥 557 `  - Flutter plugin that allows you to showcase your features on iOS and Android. ` 📝 7 days ago`
    ...
    * [In View Notifier List](https://github.com/rvamsikrishna/inview_notifier_list) ` 🔥 298 `  - A Flutter package that builds a list view and notifies when the widgets are on screen. ` 📝 9 days ago`
...
* #### Effect [🔝](#readme)
    ...
    * [Liquid Swipe](https://github.com/iamSahdeep/liquid_swipe_flutter) ` 🔥 743 `  - A flutter based liquid swipe ` 📝 16 days ago`
    ...
    * [PhotoFilters](https://github.com/skkallayath/photofilters) ` 🔥 256 `  - photofilters library for flutter ` 📝 2 days ago`
...
* #### Login [🔝](#readme)
    ...
    * [Flutter Login](https://github.com/NearHuscarl/flutter_login) ` 🔥 780 `  - Provides login screen with login/signup functionalities to help speed up development ` 📝 7 days ago`
...
* [SVG](https://github.com/dnfield/flutter_svg) ` 🔥 1.2k `  - SVG parsing, rendering, and widget library for Flutter ` 📝 13 days ago `
...
* [Crop](https://github.com/xclud/flutter_crop) ` 🔥 123 `  - Crop any widget/image in Android, iOS, Web and Desktop with fancy and customizable UI, in pure Dart code. ` 📝 14 days ago `
* [Bitmap](https://github.com/renancaraujo/bitmap) ` 🔥 110 `  - A Flutter package for manipulating bitmaps ` 📝 3 months ago `
  
* #### Image Picker [🔝](#readme)

    * [WeChat Assets Picker](https://github.com/fluttercandies/flutter_wechat_assets_picker) ` 🔥 576 `  - An assets picker in WeChat style, support multi assets picking. ` 📝 2 days ago`
...
* [FL Chart](https://github.com/imaNNeoFighT/fl_chart) ` 🔥 3.1k `  - A powerful Flutter chart library, currently supporting Line Chart, Bar Chart, Pie Chart, Scatter Chart and Radar Chart. ` 📝 18 days ago `
...
* [Graphic](https://github.com/entronad/graphic) ` 🔥 191 `  - A Flutter data visualization library based on Grammar of Graphics. ` 📝 2 months ago `
...
* [Login](https://github.com/AppleEducate/flutter_login) ` 🔥 600 `  - 100% Shared Code Android/iOS Login Example - JSON API ` 📝 a year ago `
...
* [Flutter AppAuth](https://github.com/MaikuB/flutter_appauth) ` 🔥 155 `  - A Flutter wrapper for AppAuth iOS and Android SDKs 
...
* [Parsed Text](https://github.com/fayeed/flutter_parsed_text) ` 🔥 157 `  - A Flutter package to parse text and make them into linkified text widget ` 📝 13 days ago `
* [Code Field](https://github.com/BertrandBev/code_field) ` 🔥 53 `  - A customizable code text field supporting syntax highlighting ` 📝 10 days ago `
...
* [attranslate](https://github.com/fkirc/attranslate) ` 🔥 206 `  - Semi-automated Text Translator for Websites and Apps ` 📝 10 days ago `
...
* #### Audio [🔝](#readme)
    ...
    * [Flutter Sound](https://github.com/dooboolab/flutter_sound) ` 🔥 563 `  - Flutter plugin for sound. Audio recorder and player. ` 📝 22 days ago`
    * [AssetsAudioPlayer](https://github.com/florent37/Flutter-AssetsAudioPlayer) ` 🔥 497 `  - Play simultaneously music/audio from assets/network/file directly from Flutter, compatible with android / ios / web / macos, displays notifications ` 📝 a month ago`
...
* #### Video [🔝](#readme)
    ...
    * [CamerAwesome](https://github.com/Apparence-io/camera_awesome) ` 🔥 223 `  - A flutter plugin to handle Android / iOS camera ` 📝 11 days ago`
    * [Video Trimmer](https://github.com/sbis04/video_trimmer) ` 🔥 208 `  - Flutter video trimmer package ` 📝 18 days ago`
...
* [Secure Storage](https://github.com/mogol/flutter_secure_storage) ` 🔥 611 `  - A Flutter plugin to store data in secure storage ` 📝 2 months ago `
* [Firebase Storage](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_storage)   
  
* #### Preferences [🔝](#readme)

    * [Streaming Shared Preferences](https://github.com/roughike/streaming_shared_preferences) ` 🔥 201 `  - A reactive key-value store for Flutter projects. Like shared_preferences, but with Streams. 
...
* [Square In-App Payments SDK](https://github.com/square/in-app-payments-flutter-plugin) ` 🔥 267 `  - Flutter Plugin for Square In-App Payments SDK ` 📝 11 days ago `
* [Facebook Audience Network](https://github.com/dreamsoftin/facebook_audience_network) ` 🔥 127 `  - Flutter Facebook Audience Network ` 📝 15 days ago `
...
* [FlutterFoodybite](https://github.com/JideGuru/FlutterFoodybite) ` 🔥 957 `  - Flutter representation of a Restaurant app UI. ` 📝 5 months ago `
* [Dashboard](https://github.com/Ivaskuu/dashboard) ` 🔥 786 `  - Dashboard concept made with Flutter. ` 📝 3 years ago `
...
* [Smart Washing Machine](https://github.com/pawlik92/flutter_whirlpool) ` 🔥 476 `  - Flutter UI challenge (with Box2D physic)- Smart washing machine app ` 📝 a year ago `
...
* [ActingWeb First_App](https://github.com/gregertw/actingweb_firstapp) ` 🔥 247 `  - Starter app for Flutter that includes many different production app features; some not typically included in demo apps. 
...
* [GitTouch](https://github.com/pd4d10/git-touch) ` 🔥 762 `  - An open-source app for GitHub, GitLab, Bitbucket, Gitea, and Gitee(码云), built with Flutter ` 📝 9 days ago `
...
* #### Augmented Reality [🔝](#readme)
    ...
    * [ARKit Plugin](https://github.com/olexale/arkit_flutter_plugin) ` 🔥 542 `  - ARKit Flutter Plugin ` 📝 8 days ago`
    * [ARCore Plugin](https://github.com/giandifra/arcore_flutter_plugin) ` 🔥 274 `  - Flutter plugin for ARCore SDK, Android platform to build new augmented reality experiences ` 📝 8 days ago`
...
* [Local Notifications](https://github.com/MaikuB/flutter_local_notifications) ` 🔥 1.5k `  - A Flutter plugin for displaying local notifications on Android, iOS and macOS ` 📝 18 days ago `
...
* [WebView](https://github.com/dart-flitter/flutter_webview_plugin) ` 🔥 1.3k `  - Community WebView Plugin - Allows Flutter to communicate with a native WebView. ` 📝 21 days ago `
...
* [Geolocator](https://github.com/baseflow/flutter-geolocator) ` 🔥 801 `  - Android and iOS Geolocation plugin for Flutter ` 📝 7 days ago `
...
* [Downloader](https://github.com/hnvn/flutter_downloader) ` 🔥 570 `  - Flutter Downloader - A plugin for creating and managing download tasks. Supports iOS and Android. Maintainer: @hnvn ` 📝 16 days ago `
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ` 🔥 567 `  - File picker plugin for Flutter, compatible with both iOS & Android and desktop (go-flutter). ` 📝 19 days ago `
...
* [VPN](https://github.com/X-dea/Flutter_VPN) ` 🔥 178 `  - Plugin to access VPN service for Flutter | Flutter 的 VPN 插件 ` 📝 3 months ago `
...
* [WidgetKit](https://github.com/fasky-software/flutter_widgetkit) ` 🔥 125 `  - Flutter library for iOS Widgets Extensions. Integrate a Widget into your App ` 📝 3 months ago `
...
* #### Scanner [🔝](#readme)
    ...
    * [QR Code Reader](https://github.com/villela/flutter_qrcode_reader) ` 🔥 214 `  - Flutter qrcode reader ` 📝 14 days ago`
...
* #### Bluetooth / NFC / Beacon [🔝](#readme)
    ...
    * [Reactive Ble](https://github.com/PhilipsHue/flutter_reactive_ble) ` 🔥 185 `  - Flutter library that handles BLE operations for multiple devices. ` 📝 15 days ago`
    ...
    * [NFC Manager](https://github.com/okadan/flutter-nfc-manager) ` 🔥 55 `  - Flutter plugin for accessing the NFC features on Android and iOS. 
...
* [OneSignal](https://github.com/OneSignal/OneSignal-Flutter-SDK) ` 🔥 446 `  - OneSignal is a free push notification service for mobile apps. This plugin makes it easy to integrate your flutter app with OneSignal ` 📝 9 days ago `
...
* #### Standard [🔝](#readme)
    ...
    * [Bloc](https://github.com/felangel/bloc) ` 🔥 7.2k `  - A predictable state management library that helps implement the BLoC design pattern ` 📝 6 days ago`
...
* [Form Builder](https://github.com/danvick/flutter_form_builder) ` 🔥 778 `  - Simple form maker for Flutter Framework ` 📝 25 days ago `
...
* [Ferry](https://github.com/gql-dart/ferry) ` 🔥 194 `  - Stream-based strongly typed GraphQL client for Dart ` 📝 4 days ago `
...
* [AnimatedTextKit](https://github.com/aagarwal1012/Animated-Text-Kit) ` 🔥 1.1k `  - A flutter package to create cool and beautiful text animations. [Flutter Favorite Package] ` 📝 2 months ago `
* [Staggered Animations](https://github.com/mobiten/flutter_staggered_animations) ` 🔥 833 `  - Easily add staggered animations to your ListView, GridView, Column and Row children. ` 📝 3 months ago `
* [Simple Animations](https://github.com/felixblaschke/simple_animations) ` 🔥 656 `  - Flutter package for creating awesome animations. ` 📝 2 months ago `
...
* [Sequence Animation](https://github.com/Norbert515/flutter_sequence_animation) ` 🔥 306 `  - Orchestrate multiple animations with ease. ` 📝 8 days ago `
* [Villains](https://github.com/Norbert515/flutter_villains) ` 🔥 299 `  - Flexible and easy to use page transitions. ` 📝 2 years ago `
* [Flutter-animation-set](https://github.com/efoxTeam/flutter-animation-set) ` 🔥 254 `  - Easy to build an animation set ` 📝 2 years ago `
* [Funvas](https://github.com/creativecreatorormaybenot/funvas) ` 🔥 231 `  - Fun canvas animations in Flutter based on time and math functions. ` 📝 5 days ago `
* [Animate Do](https://pub.dev/packages/animate_do)   
  
## Testing [🔝](#readme)

* [Flutter Gherkin](https://github.com/jonsamwell/flutter_gherkin) ` 🔥 131 `  - A Gherkin parsers and runner for Dart and Flutter which is very similar to cucumber ` 📝 20 days ago `
  
## Web [🔝](#readme)

* [Responsive Framework](https://github.com/Codelessly/ResponsiveFramework) ` 🔥 533 `  - Easily make Flutter apps responsive. Automatically adapt UI to different screen sizes. Responsiveness made simple. Demo: https://gallery.codelessly.com/flutterwebsites/minimal/ ` 📝 7 days ago `
  
## Experimental [🔝](#readme)

* [styled_widget](https://github.com/ReinBentdal/styled_widget) ` 🔥 521 `  - Simplifying widget style in Flutter. ` 📝 a month ago `
  
## Rendering [🔝](#readme)

* [Graphx](https://github.com/roipeker/graphx) ` 🔥 246 `  - GraphX lib for Flutter ` 📝 13 days ago `
...
* #### Open source games [🔝](#readme)
    ...
    * [Slide Puzzle](https://github.com/kevmoo/slide_puzzle) ` 🔥 128 `  - The classic slide (15) puzzle in Dart and Flutter ` 📝 13 days ago`
...
* [Fwitter](https://github.com/TheAlphamerc/flutter_twitter_clone) ` 🔥 1.3k `  - Fully functional Twitter clone built in flutter framework using Firebase realtime database and storage ` 📝 10 days ago `
...
* [Trace](https://github.com/trentpiercy/trace) ` 🔥 704 `  - Modern crypto portfolio & market explorer. Built with @flutter ` 📝 10 months ago `
* [Planets](https://github.com/sergiandreplace/flutter_planets_tutorial) ` 🔥 689 `  - The Flutter Planets app tutorial with commits per lesson 
* [Taskist](https://github.com/huextrat/Taskist) ` 🔥 680 `  - Flutter ToDo App with Firebase ` 📝 a year ago `
* [AuthPass](https://github.com/authpass/authpass) ` 🔥 661 `  - AuthPass - Password Manager based on Flutter for all platforms. Keepass 2.x (kdbx 3.x) compatible. ` 📝 21 days ago `
* [Spacex-Go](https://github.com/jesusrp98/spacex-go) ` 🔥 587 `  - Simple yet powerful, open-source SpaceX launch tracker. ` 📝 a month ago `
* [Trinity Orientation @ Univ Toronto](https://github.com/matthewtory/trinity-orientation-2018) ` 🔥 522 `  - An app for orientation week at Trinity College, University of Toronto. Made with Flutter ` 📝 2 years ago `
...
* [DroidKaigi2018-flutter](https://github.com/konifar/droidkaigi2018-flutter) ` 🔥 498 `  - The unofficial conference app for DroidKaigi 2018 Tokyo ` 📝 3 years ago `
...
* [Harpy](https://github.com/robertodoering/harpy) ` 🔥 430 `  - A Twitter app built with Flutter ` 📝 5 days ago `
...
* [Deer](https://github.com/aleksanderwozniak/deer) ` 🔥 278 `  - Minimalist Flutter Todo App, built using BLoC pattern ` 📝 7 months ago `
...
* [FVM](https://github.com/leoafarias/fvm) ` 🔥 1.7k `  - Flutter Version Management: A simple CLI to manage Flutter SDK versions. ` 📝 12 days ago `
...
* [Very Good Cli](https://github.com/VeryGoodOpenSource/very_good_cli) ` 🔥 778 `  - A Very Good Command Line Interface for Dart created by Very Good Ventures ` 📝 16 days ago `
* [FlutterGen](https://github.com/FlutterGen/flutter_gen) ` 🔥 644 `  - The Flutter code generator for your assets, fonts, colors, … — Get rid of all String-based APIs. ` 📝 15 days ago `
...
* [Flutter Flavorizr](https://github.com/AngeloAvv/flutter_flavorizr) ` 🔥 120 `  - A flutter utility to easily create flavors in your flutter application ` 📝 2 months ago `
* [Environment Configuration](https://github.com/TatsuUkraine/dart_environment_config) ` 🔥 78 `  - Environment specific config generator for Dart and Flutter applications during CI/CD builds ` 📝 2 months ago `
* [Fontify](https://github.com/westracer/fontify) ` 🔥 67 `  - Converts SVG icons to OTF font and generates Flutter-compatible class. Provides an API and a CLI tool. 
...
* [Raspberry Pi Embedder](https://github.com/ardera/flutter-pi) ` 🔥 606 `  - A light-weight Flutter Engine Embedder for Raspberry Pi that runs without X. ` 📝 5 days ago `
* [bitsdojo_window](https://github.com/bitsdojo/bitsdojo_window) ` 🔥 193 `  - A Flutter package that makes it easy to customize and work with your Flutter desktop app window. ` 📝 5 days ago `
...
* [Interview Questions](https://github.com/whatsupcoders/Flutter-Interview-Questions) ` 🔥 261 `  - This repo contains a list of helpful Flutter related questions you can use to interview potential candidates. ` 📝 a year ago `
