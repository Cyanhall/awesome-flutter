...
* [Roadmap to Flutter Development](https://github.com/olexale/flutter_roadmap) ` 🔥 2k `  - Highly Subjective Roadmap to Flutter Development ` 📝 13 days ago `
...
* [Flutter Examples](https://github.com/nisrulz/flutter-examples) ` 🔥 5.5k `  - [Examples] Simple basic isolated apps, for budding flutter devs. ` 📝 21 days ago `
* [Official Gallery](https://github.com/flutter/gallery) ` 🔥 2.5k `  - Flutter Gallery is a resource to help developers evaluate and use Flutter ` 📝 8 days ago `
* [Flutter Catalog](https://github.com/X-Wei/flutter_catalog) ` 🔥 1.5k `  - An app showcasing Flutter components, with side-by-side source code view. ` 📝 5 days ago `
...
* [Liquid Pull To Refresh](https://github.com/aagarwal1012/Liquid-Pull-To-Refresh) ` 🔥 821 `  - A custom refresh indicator for flutter. ` 📝 3 months ago `
* [Flushbar](https://github.com/AndreHaueisen/flushbar) ` 🔥 794 `  - Custom widget for Flutter ` 📝 a year ago `
* [Tinder Cards](https://github.com/Ivaskuu/tinder_cards) ` 🔥 607 `  - Tinder like cards swipe effect with Flutter. ` 📝 a year ago `
* [Typeahead](https://github.com/AbdulRahmanAlHamali/flutter_typeahead) ` 🔥 504 `  - A TypeAhead widget for Flutter, where you can show suggestions to users as they type ` 📝 a month ago `
* [Before After](https://github.com/xsahil03x/before_after) ` 🔥 488 `  - A flutter package which makes it easier to display the difference between two images. ` 📝 7 months ago `
* [Flip Panel](https://github.com/hnvn/flutter_flip_panel) ` 🔥 400 `  - A package for flip panel with built-in animation ` 📝 2 years ago `
* [Direct Select](https://github.com/LanarsInc/direct-select-flutter) ` 🔥 400 `  - DirectSelect is a selection widget with an ethereal, full-screen modal popup displaying the available choices when the widget is interact with. https://dribbble.com/shots/3876250-DirectSelect-Dropdown-ux ` 📝 18 days ago `
...
* [Timeline Tile](https://github.com/JHBitencourt/timeline_tile) ` 🔥 350 `  - A package to help build customisable timelines in Flutter. ` 📝 3 months ago `
* [Snaplist](https://github.com/ariedov/flutter_snaplist) ` 🔥 339 `  - A small library for creating snapping lists. ` 📝 a year ago `
* [Timelines](https://github.com/chulwoo-park/timelines) ` 🔥 309 `  - A powerful & easy to use timeline package for Flutter! ` 📝 2 months ago `
...
* [Card Settings](https://github.com/codegrue/card_settings) ` 🔥 279 `  - A flutter package for building card based forms. ` 📝 10 days ago `
* [Flutter Tags](https://github.com/Dn-a/flutter_tags) ` 🔥 267 `  - With flutter tags you can create selectable or input tags that automatically adapt to the screen width ` 📝 7 months ago `
* [Scratcher](https://github.com/vintage/scratcher) ` 🔥 250 `  - Scratch card widget which temporarily hides content from user. ` 📝 17 days ago `
...
* [Pin Code](https://github.com/LiewJunTung/pin_code_text_field) ` 🔥 194 `  - A highly customisable Flutter widget for entering pin code. Suitable for use cases such as login and OTP. ` 📝 5 months ago `
...
* #### Sticky Headers [🔝](#readme)
    ...
    * [Sticky Header](https://github.com/letsar/flutter_sticky_header) ` 🔥 624 `  - Flutter implementation of sticky headers for sliver ` 📝 2 months ago`
    * [Sticky Infinite List](https://github.com/TatsuUkraine/flutter_sticky_infinite_list) ` 🔥 216 `  - Multi directional infinite list with Sticky headers for Flutter applications ` 📝 2 months ago`
  
* #### Drawers [🔝](#readme)

    * [Flutter Inner Drawer](https://github.com/Dn-a/flutter_inner_drawer) ` 🔥 306 `  - Inner Drawer is an easy way to create an internal side section (left/right) where you can insert a list-menu or other. ` 📝 3 months ago`
...
* #### Bottom bars [🔝](#readme)
    ...
    * [Fancy Bottom Navigation](https://github.com/tunitowen/fancy_bottom_navigation) ` 🔥 479 `  - Flutter plugin - FancyBottomNavigation ` 📝 3 months ago`
    * [Google Nav Bar](https://github.com/sooxt98/google_nav_bar) ` 🔥 343 `  - A modern google style nav bar for flutter. ` 📝 a month ago`
...
* #### Bottom Sheets [🔝](#readme)
    ...
    * [Modal Bottom Sheet](https://github.com/jamesblasco/modal_bottom_sheet) ` 🔥 901 `  - Flutter | Create advanced modal bottom sheets. Material, Cupertino or your own style ` 📝 5 months ago`
    * [Rubber Bottom Sheet](https://github.com/mcrovero/rubber) ` 🔥 365 `  - An elastic material bottom sheet implementation for Flutter. ` 📝 2 months ago`
...
* #### Sliders [🔝](#readme)
    ...
    * [Fluid Slider](https://github.com/rvamsikrishna/flutter_fluid_slider) ` 🔥 245 `  - A fluid design slider that works just like the Slider material widget. ` 📝 a year ago`
  
* #### UI Helpers [🔝](#readme)

    * [Liquid Pull To Refresh](https://github.com/aagarwal1012/Liquid-Pull-To-Refresh) ` 🔥 821 `  - A custom refresh indicator for flutter. ` 📝 3 months ago`
    * [Offline](https://github.com/jogboms/flutter_offline) ` 🔥 663 `  - A tidy utility to handle offline/online connectivity like a Boss ` 📝 3 months ago`
    * [ShowCaseView](https://github.com/simformsolutions/flutter_showcaseview) ` 🔥 552 `  - Flutter plugin that allows you to showcase your features on iOS and Android. ` 📝 3 days ago`
    * [Reorderables](https://github.com/hanshengchiu/reorderables) ` 🔥 373 `  - Reorderable table, row, column, wrap, and sliver list that allow drag and drop of the children. https://pub.dartlang.org/packages/reorderables ` 📝 2 months ago`
    * [In View Notifier List](https://github.com/rvamsikrishna/inview_notifier_list) ` 🔥 296 `  - A Flutter package that builds a list view and notifies when the widgets are on screen. ` 📝 a year ago`
    * [Scroll To Index](https://github.com/quire-io/scroll-to-index) ` 🔥 264 `  - scroll to index with fixed/variable row height inside Flutter scrollable widget ` 📝 3 months ago`
...
* #### Material Design [🔝](#readme)
    ...
    * [Slidable](https://github.com/letsar/flutter_slidable) ` 🔥 1.8k `  - A Flutter implementation of slidable list item with directional slide actions. ` 📝 22 days ago`
...
* #### Effect [🔝](#readme)
    ...
    * [Liquid Swipe](https://github.com/iamSahdeep/liquid_swipe_flutter) ` 🔥 739 `  - A flutter based liquid swipe ` 📝 6 days ago`
    ...
    * [Clay Containers](https://github.com/mcaubrey/clay_containers) ` 🔥 323 `  - Neumorphic containers and text widget primitives to serve as the foundation of your own unique neumorphic designs. ` 📝 3 months ago`
    * [PhotoFilters](https://github.com/skkallayath/photofilters) ` 🔥 253 `  - photofilters library for flutter ` 📝 2 months ago`
...
* #### Calendar [🔝](#readme)
    ...
    * [Table Calendar](https://github.com/aleksanderwozniak/table_calendar) ` 🔥 991 `  - Highly customizable, feature-packed calendar widget for Flutter ` 📝 2 months ago`
    * [Calendar Carousel Widget](https://github.com/dooboolab/flutter_calendar_carousel) ` 🔥 646 `  - Calendar widget for flutter that is swipeable horizontally. This widget can help you build your own calendar widget highly customizable. ` 📝 2 months ago`
...
* #### Login [🔝](#readme)
    ...
    * [Flutter Login](https://github.com/NearHuscarl/flutter_login) ` 🔥 769 `  - Provides login screen with login/signup functionalities to help speed up development ` 📝 a day ago`
    * [Login Animation](https://github.com/GeekyAnts/flutter-login-home-animation)   
  
* #### Backend-Driven [🔝](#readme)

    * [Dynamic Widget](https://github.com/dengyin2000/dynamic_widget) ` 🔥 922 `  - A Backend-Driven UI toolkit, build your dynamic UI with json, and the json format is very similar with flutter widget code. ` 📝 2 months ago`
...
* [Multi Image Picker](https://github.com/Sh1d0w/multi_image_picker) ` 🔥 903 `  - Flutter plugin that allows you to display multi image picker on iOS and Android. ` 📝 20 days ago `
* [Image Cropper](https://github.com/hnvn/flutter_image_cropper) ` 🔥 757 `  - A Flutter plugin for Android and iOS supports cropping images ` 📝 3 months ago `
...
* [Crop](https://github.com/xclud/flutter_crop) ` 🔥 123 `  - Crop any widget/image in Android, iOS, Web and Desktop with fancy and customizable UI, in pure Dart code. ` 📝 4 days ago `
* [Bitmap](https://github.com/renancaraujo/bitmap) ` 🔥 109 `  - A Flutter package for manipulating bitmaps ` 📝 3 months ago `
  
* #### Image Picker [🔝](#readme)

    * [WeChat Assets Picker](https://github.com/fluttercandies/flutter_wechat_assets_picker) ` 🔥 566 `  - An assets picker in WeChat style, support multi assets picking. ` 📝 7 days ago`
...
* [Google Map View](https://github.com/apptreesoftware/flutter_google_map_view) ` 🔥 411 `  - A flutter plugin for Google Maps ` 📝 3 years ago `
...
* [FL Chart](https://github.com/imaNNeoFighT/fl_chart) ` 🔥 3.1k `  - A powerful Flutter chart library, currently supporting Line Chart, Bar Chart, Pie Chart, Scatter Chart and Radar Chart. ` 📝 8 days ago `
...
* [Candlesticks](https://github.com/trentpiercy/flutter-candlesticks) ` 🔥 334 `  - Elegant OHLC Candlestick and Trade Volume charts for @flutter ` 📝 23 days ago `
...
* [Get](https://github.com/jonataslaw/get) ` 🔥 3.6k `  - Open screens/snackbars/dialogs/bottomSheets without context, manage states and inject dependencies easily with Get. ` 📝 3 days ago `
...
* [Code Field](https://github.com/BertrandBev/code_field) ` 🔥 52 `  - A customizable code text field supporting syntax highlighting ` 📝 12 days ago `
...
* #### Audio [🔝](#readme)
    ...
    * [Flutter Sound](https://github.com/dooboolab/flutter_sound) ` 🔥 559 `  - Flutter plugin for sound. Audio recorder and player. ` 📝 12 days ago`
...
* #### Video [🔝](#readme)
    ...
    * [CamerAwesome](https://github.com/Apparence-io/camera_awesome) ` 🔥 219 `  - A flutter plugin to handle Android / iOS camera ` 📝 8 days ago`
    * [Video Trimmer](https://github.com/sbis04/video_trimmer) ` 🔥 205 `  - Flutter video trimmer package ` 📝 8 days ago`
...
* [Square In-App Payments SDK](https://github.com/square/in-app-payments-flutter-plugin) ` 🔥 267 `  - Flutter Plugin for Square In-App Payments SDK ` 📝 15 days ago `
* [Facebook Audience Network](https://github.com/dreamsoftin/facebook_audience_network) ` 🔥 127 `  - Flutter Facebook Audience Network ` 📝 5 days ago `
...
* [Restaurant Menu](https://github.com/braulio94/menu_flutter) ` 🔥 538 `  - restaurant menu app made with flutter inspired by this design https://goo.gl/jChLBV ` 📝 3 years ago `
...
* [ActingWeb First_App](https://github.com/gregertw/actingweb_firstapp) ` 🔥 244 `  - Starter app for Flutter that includes many different production app features; some not typically included in demo apps. ` 📝 11 days ago `
...
* [GitTouch](https://github.com/pd4d10/git-touch) ` 🔥 753 `  - An open-source app for GitHub, GitLab, Bitbucket, Gitea, and Gitee(码云), built with Flutter ` 📝 4 days ago `
  
## Machine Learning [🔝](#readme)

* [m2gen](https://github.com/BayesWitnesses/m2cgen) ` 🔥 1.8k ` ` 🌐 6 ` - Transform ML models into a native code (Java, C, Python, Go, JavaScript, Visual Basic, C#, R, PowerShell, PHP, Dart, Haskell, Ruby) with zero dependencies ` 📝 17 days ago `
...
* #### Augmented Reality [🔝](#readme)
    ...
    * [ARKit Plugin](https://github.com/olexale/arkit_flutter_plugin) ` 🔥 540 `  - ARKit Flutter Plugin ` 📝 13 days ago`
    * [ARCore Plugin](https://github.com/giandifra/arcore_flutter_plugin) ` 🔥 269 `  - Flutter plugin for ARCore SDK, Android platform to build new augmented reality experiences ` 📝 20 days ago`
...
* [WebView](https://github.com/dart-flitter/flutter_webview_plugin) ` 🔥 1.3k `  - Community WebView Plugin - Allows Flutter to communicate with a native WebView. ` 📝 11 days ago `
...
* [Geolocator](https://github.com/baseflow/flutter-geolocator) ` 🔥 800 `  - Android and iOS Geolocation plugin for Flutter ` 📝 24 days ago `
* [Location](https://github.com/Lyokone/flutterlocation) ` 🔥 742 `  - A Flutter plugin to easily handle realtime location in iOS and Android. Provides settings for optimizing performance or battery. ` 📝 25 days ago `
* [Downloader](https://github.com/hnvn/flutter_downloader) ` 🔥 567 `  - Flutter Downloader - A plugin for creating and managing download tasks. Supports iOS and Android. Maintainer: @hnvn ` 📝 6 days ago `
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ` 🔥 559 `  - File picker plugin for Flutter, compatible with both iOS & Android and desktop (go-flutter). ` 📝 9 days ago `
...
* #### Scanner [🔝](#readme)
    ...
    * [QR Code Reader](https://github.com/villela/flutter_qrcode_reader) ` 🔥 213 `  - Flutter qrcode reader ` 📝 4 days ago`
...
* #### Bluetooth / NFC / Beacon [🔝](#readme)
    ...
    * [NFC Manager](https://github.com/okadan/flutter-nfc-manager) ` 🔥 55 `  - Flutter plugin for accessing the NFC features on Android and iOS. ` 📝 8 days ago`
...
* #### Standard [🔝](#readme)
    ...
    * [GetX](https://github.com/jonataslaw/getx) ` 🔥 3.6k `  - Open screens/snackbars/dialogs/bottomSheets without context, manage states and inject dependencies easily with Get. ` 📝 3 days ago`
    ...
    * [RiverPod](https://github.com/rrousselGit/river_pod) ` 🔥 1.6k `  - A simple way to access state while robust and testable. ` 📝 18 days ago`
...
* [Form Builder](https://github.com/danvick/flutter_form_builder) ` 🔥 768 `  - Simple form maker for Flutter Framework ` 📝 15 days ago `
...
* [Ferry](https://github.com/gql-dart/ferry) ` 🔥 190 `  - Stream-based strongly typed GraphQL client for Dart ` 📝 4 days ago `
...
* [Funvas](https://github.com/creativecreatorormaybenot/funvas) ` 🔥 217 `  - Fun canvas animations in Flutter based on time and math functions. ` 📝 22 days ago `
* [Animate Do](https://pub.dev/packages/animate_do)   
  
## Testing [🔝](#readme)

* [Flutter Gherkin](https://github.com/jonsamwell/flutter_gherkin) ` 🔥 130 `  - A Gherkin parsers and runner for Dart and Flutter which is very similar to cucumber ` 📝 10 days ago `
...
* #### Open source games [🔝](#readme)
    ...
    * [Slide Puzzle](https://github.com/kevmoo/slide_puzzle) ` 🔥 126 `  - The classic slide (15) puzzle in Dart and Flutter ` 📝 3 days ago`
...
* [Flutter Team Samples](https://github.com/flutter/samples) ` 🔥 9.9k `  - A collection of Flutter examples and demos. ` 📝 9 days ago `
...
* [GitJournal](https://github.com/GitJournal/GitJournal) ` 🔥 1.4k `  - Mobile first Note Taking integrated with Git ` 📝 4 days ago `
...
* [AuthPass](https://github.com/authpass/authpass) ` 🔥 655 `  - AuthPass - Password Manager based on Flutter for all platforms. Keepass 2.x (kdbx 3.x) compatible. ` 📝 11 days ago `
...
* [Harpy](https://github.com/robertodoering/harpy) ` 🔥 414 `  - A Twitter app built with Flutter ` 📝 10 days ago `
...
* [FVM](https://github.com/leoafarias/fvm) ` 🔥 1.7k `  - Flutter Version Management: A simple CLI to manage Flutter SDK versions. ` 📝 9 days ago `
...
* [Very Good Cli](https://github.com/VeryGoodOpenSource/very_good_cli) ` 🔥 769 `  - A Very Good Command Line Interface for Dart created by Very Good Ventures ` 📝 6 days ago `
* [FlutterGen](https://github.com/FlutterGen/flutter_gen) ` 🔥 635 `  - The Flutter code generator for your assets, fonts, colors, … — Get rid of all String-based APIs. ` 📝 5 days ago `
...
* [Raspberry Pi Embedder](https://github.com/ardera/flutter-pi) ` 🔥 595 `  - A light-weight Flutter Engine Embedder for Raspberry Pi that runs without X. ` 📝 6 days ago `
