...
* [Roadmap to Flutter Development](https://github.com/olexale/flutter_roadmap) ` 🔥 2k `  - Highly Subjective Roadmap to Flutter Development ` 📝 15 days ago `
...
* [Official Gallery](https://github.com/flutter/gallery) ` 🔥 2.5k `  - Flutter Gallery is a resource to help developers evaluate and use Flutter ` 📝 10 days ago `
* [Flutter Catalog](https://github.com/X-Wei/flutter_catalog) ` 🔥 1.5k `  - An app showcasing Flutter components, with side-by-side source code view. ` 📝 7 days ago `
...
* [Direct Select](https://github.com/LanarsInc/direct-select-flutter) ` 🔥 400 `  - DirectSelect is a selection widget with an ethereal, full-screen modal popup displaying the available choices when the widget is interact with. https://dribbble.com/shots/3876250-DirectSelect-Dropdown-ux ` 📝 20 days ago `
...
* [Card Settings](https://github.com/codegrue/card_settings) ` 🔥 279 `  - A flutter package for building card based forms. ` 📝 12 days ago `
...
* [Scratcher](https://github.com/vintage/scratcher) ` 🔥 250 `  - Scratch card widget which temporarily hides content from user. ` 📝 19 days ago `
...
* #### UI Helpers [🔝](#readme)
    ...
    * [ShowCaseView](https://github.com/simformsolutions/flutter_showcaseview) ` 🔥 552 `  - Flutter plugin that allows you to showcase your features on iOS and Android. ` 📝 5 days ago`
...
* #### Material Design [🔝](#readme)
    ...
    * [Slidable](https://github.com/letsar/flutter_slidable) ` 🔥 1.8k `  - A Flutter implementation of slidable list item with directional slide actions. ` 📝 24 days ago`
...
* #### Effect [🔝](#readme)
    ...
    * [Liquid Swipe](https://github.com/iamSahdeep/liquid_swipe_flutter) ` 🔥 739 `  - A flutter based liquid swipe ` 📝 8 days ago`
...
* #### Login [🔝](#readme)
    ...
    * [Flutter Login](https://github.com/NearHuscarl/flutter_login) ` 🔥 769 `  - Provides login screen with login/signup functionalities to help speed up development ` 📝 3 days ago`
...
* [Multi Image Picker](https://github.com/Sh1d0w/multi_image_picker) ` 🔥 903 `  - Flutter plugin that allows you to display multi image picker on iOS and Android. ` 📝 22 days ago `
...
* #### Image Picker [🔝](#readme)
    ...
    * [WeChat Assets Picker](https://github.com/fluttercandies/flutter_wechat_assets_picker) ` 🔥 566 `  - An assets picker in WeChat style, support multi assets picking. ` 📝 9 days ago`
...
* [FL Chart](https://github.com/imaNNeoFighT/fl_chart) ` 🔥 3.1k `  - A powerful Flutter chart library, currently supporting Line Chart, Bar Chart, Pie Chart, Scatter Chart and Radar Chart. ` 📝 10 days ago `
...
* [Candlesticks](https://github.com/trentpiercy/flutter-candlesticks) ` 🔥 334 `  - Elegant OHLC Candlestick and Trade Volume charts for @flutter ` 📝 25 days ago `
...
* [SimpleAuth](https://github.com/Clancey/simple_auth) ` 🔥 285 `  - The Simplest way to Authenticate in Flutter ` 📝 2 days ago `
...
* [Flutter AppAuth](https://github.com/MaikuB/flutter_appauth) ` 🔥 154 `  - A Flutter wrapper for AppAuth iOS and Android SDKs ` 📝 2 days ago `
...
* [Parsed Text](https://github.com/fayeed/flutter_parsed_text) ` 🔥 157 `  - A Flutter package to parse text and make them into linkified text widget ` 📝 5 days ago `
* [Code Field](https://github.com/BertrandBev/code_field) ` 🔥 52 `  - A customizable code text field supporting syntax highlighting ` 📝 2 days ago `
...
* [attranslate](https://github.com/fkirc/attranslate) ` 🔥 206 `  - Semi-automated Text Translator for Websites and Apps ` 📝 2 days ago `
...
* #### Audio [🔝](#readme)
    ...
    * [Flutter Sound](https://github.com/dooboolab/flutter_sound) ` 🔥 560 `  - Flutter plugin for sound. Audio recorder and player. ` 📝 14 days ago`
...
* #### Video [🔝](#readme)
    ...
    * [WebRTC](https://github.com/cloudwebrtc/flutter-webrtc) ` 🔥 2.3k `  - WebRTC plugin for Flutter Mobile/Desktop/Web ` 📝 18 hours ago`
    * [Chewie](https://github.com/brianegan/chewie) ` 🔥 1.2k `  - The video player for Flutter with a heart of gold ` 📝 5 days ago`
    * [CamerAwesome](https://github.com/Apparence-io/camera_awesome) ` 🔥 222 `  - A flutter plugin to handle Android / iOS camera ` 📝 3 days ago`
    * [Video Trimmer](https://github.com/sbis04/video_trimmer) ` 🔥 208 `  - Flutter video trimmer package ` 📝 10 days ago`
...
* [Square In-App Payments SDK](https://github.com/square/in-app-payments-flutter-plugin) ` 🔥 267 `  - Flutter Plugin for Square In-App Payments SDK ` 📝 3 days ago `
* [Facebook Audience Network](https://github.com/dreamsoftin/facebook_audience_network) ` 🔥 127 `  - Flutter Facebook Audience Network ` 📝 7 days ago `
...
* [ActingWeb First_App](https://github.com/gregertw/actingweb_firstapp) ` 🔥 247 `  - Starter app for Flutter that includes many different production app features; some not typically included in demo apps. ` 📝 12 hours ago `
...
* [GitTouch](https://github.com/pd4d10/git-touch) ` 🔥 759 `  - An open-source app for GitHub, GitLab, Bitbucket, Gitea, and Gitee(码云), built with Flutter ` 📝 6 days ago `
...
* #### Augmented Reality [🔝](#readme)
    ...
    * [ARKit Plugin](https://github.com/olexale/arkit_flutter_plugin) ` 🔥 540 `  - ARKit Flutter Plugin ` 📝 14 hours ago`
    * [ARCore Plugin](https://github.com/giandifra/arcore_flutter_plugin) ` 🔥 273 `  - Flutter plugin for ARCore SDK, Android platform to build new augmented reality experiences ` 📝 22 days ago`
...
* [WebView](https://github.com/dart-flitter/flutter_webview_plugin) ` 🔥 1.3k `  - Community WebView Plugin - Allows Flutter to communicate with a native WebView. ` 📝 13 days ago `
...
* [Geolocator](https://github.com/baseflow/flutter-geolocator) ` 🔥 801 `  - Android and iOS Geolocation plugin for Flutter ` 📝 3 days ago `
* [Location](https://github.com/Lyokone/flutterlocation) ` 🔥 744 `  - A Flutter plugin to easily handle realtime location in iOS and Android. Provides settings for optimizing performance or battery. ` 📝 7 hours ago `
* [Downloader](https://github.com/hnvn/flutter_downloader) ` 🔥 567 `  - Flutter Downloader - A plugin for creating and managing download tasks. Supports iOS and Android. Maintainer: @hnvn ` 📝 8 days ago `
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ` 🔥 565 `  - File picker plugin for Flutter, compatible with both iOS & Android and desktop (go-flutter). ` 📝 11 days ago `
...
* [UDID](https://github.com/GigaDroid/flutter_udid) ` 🔥 153 `  - Plugin to retrieve a persistent UDID across app reinstalls on iOS and Android. ` 📝 2 months ago `
...
* #### Scanner [🔝](#readme)
    ...
    * [QR Code Reader](https://github.com/villela/flutter_qrcode_reader) ` 🔥 213 `  - Flutter qrcode reader ` 📝 6 days ago`
...
* #### Bluetooth / NFC / Beacon [🔝](#readme)
    ...
    * [Reactive Ble](https://github.com/PhilipsHue/flutter_reactive_ble) ` 🔥 185 `  - Flutter library that handles BLE operations for multiple devices. ` 📝 7 days ago`
    ...
    * [NFC Manager](https://github.com/okadan/flutter-nfc-manager) ` 🔥 55 `  - Flutter plugin for accessing the NFC features on Android and iOS. ` 📝 21 hours ago`
...
* [OneSignal](https://github.com/OneSignal/OneSignal-Flutter-SDK) ` 🔥 446 `  - OneSignal is a free push notification service for mobile apps. This plugin makes it easy to integrate your flutter app with OneSignal ` 📝 a day ago `
...
* #### Standard [🔝](#readme)
    ...
    * [RiverPod](https://github.com/rrousselGit/river_pod) ` 🔥 1.6k `  - A simple way to access state while robust and testable. ` 📝 13 hours ago`
...
* #### Redux / ELM / Dependency Injection [🔝](#readme)
    ...
    * [Redux.dart](https://github.com/johnpryan/redux.dart) ` 🔥 465 `  - Redux for Dart ` 📝 2 months ago`
...
* [Form Builder](https://github.com/danvick/flutter_form_builder) ` 🔥 777 `  - Simple form maker for Flutter Framework ` 📝 17 days ago `
* [Functional widget](https://github.com/rrousselGit/functional_widget) ` 🔥 397 `  - A code generator to write widgets as function without loosing the benefits of classes. ` 📝 a month ago `
...
* [Ferry](https://github.com/gql-dart/ferry) ` 🔥 193 `  - Stream-based strongly typed GraphQL client for Dart ` 📝 4 days ago `
...
* [Simple Animations](https://github.com/felixblaschke/simple_animations) ` 🔥 652 `  - Flutter package for creating awesome animations. ` 📝 a month ago `
...
* [Funvas](https://github.com/creativecreatorormaybenot/funvas) ` 🔥 222 `  - Fun canvas animations in Flutter based on time and math functions. ` 📝 5 hours ago `
* [Animate Do](https://pub.dev/packages/animate_do)   
  
## Testing [🔝](#readme)

* [Flutter Gherkin](https://github.com/jonsamwell/flutter_gherkin) ` 🔥 130 `  - A Gherkin parsers and runner for Dart and Flutter which is very similar to cucumber ` 📝 12 days ago `
...
* [Graphx](https://github.com/roipeker/graphx) ` 🔥 244 `  - GraphX lib for Flutter ` 📝 5 days ago `
  
## Game [🔝](#readme)

* [Flame](https://github.com/flame-engine/flame) ` 🔥 4.4k `  - A minimalist Flutter game engine ` 📝 13 hours ago `
...
* #### Open source games [🔝](#readme)
    ...
    * [Slide Puzzle](https://github.com/kevmoo/slide_puzzle) ` 🔥 128 `  - The classic slide (15) puzzle in Dart and Flutter ` 📝 5 days ago`
...
* [Flutter Team Samples](https://github.com/flutter/samples) ` 🔥 9.9k `  - A collection of Flutter examples and demos. ` 📝 a day ago `
...
* [GitJournal](https://github.com/GitJournal/GitJournal) ` 🔥 1.4k `  - Mobile first Note Taking integrated with Git ` 📝 5 hours ago `
...
* [Pokedex](https://github.com/scitbiz/flutter_pokedex) ` 🔥 1.1k `  - Pokedex app built with Flutter (with lots of animations) using Clean Architecture ` 📝 12 hours ago `
...
* [AuthPass](https://github.com/authpass/authpass) ` 🔥 659 `  - AuthPass - Password Manager based on Flutter for all platforms. Keepass 2.x (kdbx 3.x) compatible. ` 📝 13 days ago `
* [Spacex-Go](https://github.com/jesusrp98/spacex-go) ` 🔥 584 `  - Simple yet powerful, open-source SpaceX launch tracker. ` 📝 a month ago `
...
* [Harpy](https://github.com/robertodoering/harpy) ` 🔥 426 `  - A Twitter app built with Flutter ` 📝 11 hours ago `
...
* [Very Good Cli](https://github.com/VeryGoodOpenSource/very_good_cli) ` 🔥 775 `  - A Very Good Command Line Interface for Dart created by Very Good Ventures ` 📝 8 days ago `
* [FlutterGen](https://github.com/FlutterGen/flutter_gen) ` 🔥 640 `  - The Flutter code generator for your assets, fonts, colors, … — Get rid of all String-based APIs. ` 📝 7 days ago `
