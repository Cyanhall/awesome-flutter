...
* [Roadmap to Flutter Development](https://github.com/olexale/flutter_roadmap) ` 🔥 2k `  - Highly Subjective Roadmap to Flutter Development ` 📝 21 days ago `
...
* [Official Gallery](https://github.com/flutter/gallery) ` 🔥 2.5k `  - Flutter Gallery is a resource to help developers evaluate and use Flutter ` 📝 16 days ago `
* [Flutter Catalog](https://github.com/X-Wei/flutter_catalog) ` 🔥 1.5k `  - An app showcasing Flutter components, with side-by-side source code view. ` 📝 13 days ago `
...
* [Direct Select](https://github.com/LanarsInc/direct-select-flutter) ` 🔥 404 `  - DirectSelect is a selection widget with an ethereal, full-screen modal popup displaying the available choices when the widget is interact with. https://dribbble.com/shots/3876250-DirectSelect-Dropdown-ux ` 📝 a month ago `
...
* [Timelines](https://github.com/chulwoo-park/timelines) ` 🔥 316 `  - A powerful & easy to use timeline package for Flutter! ` 📝 3 months ago `
* [Dough](https://github.com/HatFeather/flutter_dough) ` 🔥 288 `  - This package provides some widgets you can use to create a smooshy UI. ` 📝 3 months ago `
* [Card Settings](https://github.com/codegrue/card_settings) ` 🔥 282 `  - A flutter package for building card based forms. ` 📝 18 days ago `
...
* [Scratcher](https://github.com/vintage/scratcher) ` 🔥 253 `  - Scratch card widget which temporarily hides content from user. ` 📝 25 days ago `
...
* #### UI Helpers [🔝](#readme)
    ...
    * [ShowCaseView](https://github.com/simformsolutions/flutter_showcaseview) ` 🔥 556 `  - Flutter plugin that allows you to showcase your features on iOS and Android. ` 📝 5 days ago`
    ...
    * [In View Notifier List](https://github.com/rvamsikrishna/inview_notifier_list) ` 🔥 297 `  - A Flutter package that builds a list view and notifies when the widgets are on screen. ` 📝 7 days ago`
...
* #### Effect [🔝](#readme)
    ...
    * [Liquid Swipe](https://github.com/iamSahdeep/liquid_swipe_flutter) ` 🔥 742 `  - A flutter based liquid swipe ` 📝 14 days ago`
...
* #### Login [🔝](#readme)
    ...
    * [Flutter Login](https://github.com/NearHuscarl/flutter_login) ` 🔥 776 `  - Provides login screen with login/signup functionalities to help speed up development ` 📝 5 days ago`
...
* [SVG](https://github.com/dnfield/flutter_svg) ` 🔥 1.2k `  - SVG parsing, rendering, and widget library for Flutter ` 📝 11 days ago `
...
* [Crop](https://github.com/xclud/flutter_crop) ` 🔥 123 `  - Crop any widget/image in Android, iOS, Web and Desktop with fancy and customizable UI, in pure Dart code. ` 📝 12 days ago `
* [Bitmap](https://github.com/renancaraujo/bitmap) ` 🔥 110 `  - A Flutter package for manipulating bitmaps ` 📝 3 months ago `
  
* #### Image Picker [🔝](#readme)

    * [WeChat Assets Picker](https://github.com/fluttercandies/flutter_wechat_assets_picker) ` 🔥 570 `  - An assets picker in WeChat style, support multi assets picking. ` 📝 4 days ago`
...
* [SimpleAuth](https://github.com/Clancey/simple_auth) ` 🔥 285 `  - The Simplest way to Authenticate in Flutter ` 📝 3 days ago `
...
* [Parsed Text](https://github.com/fayeed/flutter_parsed_text) ` 🔥 157 `  - A Flutter package to parse text and make them into linkified text widget ` 📝 11 days ago `
* [Code Field](https://github.com/BertrandBev/code_field) ` 🔥 53 `  - A customizable code text field supporting syntax highlighting ` 📝 8 days ago `
...
* [attranslate](https://github.com/fkirc/attranslate) ` 🔥 206 `  - Semi-automated Text Translator for Websites and Apps ` 📝 8 days ago `
...
* #### Audio [🔝](#readme)
    ...
    * [Flutter Sound](https://github.com/dooboolab/flutter_sound) ` 🔥 563 `  - Flutter plugin for sound. Audio recorder and player. ` 📝 20 days ago`
...
* #### Video [🔝](#readme)
    ...
    * [CamerAwesome](https://github.com/Apparence-io/camera_awesome) ` 🔥 223 `  - A flutter plugin to handle Android / iOS camera ` 📝 9 days ago`
    * [Video Trimmer](https://github.com/sbis04/video_trimmer) ` 🔥 208 `  - Flutter video trimmer package ` 📝 16 days ago`
...
* [Square In-App Payments SDK](https://github.com/square/in-app-payments-flutter-plugin) ` 🔥 267 `  - Flutter Plugin for Square In-App Payments SDK ` 📝 9 days ago `
* [Facebook Audience Network](https://github.com/dreamsoftin/facebook_audience_network) ` 🔥 127 `  - Flutter Facebook Audience Network ` 📝 13 days ago `
...
* [GitTouch](https://github.com/pd4d10/git-touch) ` 🔥 762 `  - An open-source app for GitHub, GitLab, Bitbucket, Gitea, and Gitee(码云), built with Flutter ` 📝 7 days ago `
...
* #### Augmented Reality [🔝](#readme)
    ...
    * [ARKit Plugin](https://github.com/olexale/arkit_flutter_plugin) ` 🔥 542 `  - ARKit Flutter Plugin ` 📝 6 days ago`
    * [ARCore Plugin](https://github.com/giandifra/arcore_flutter_plugin) ` 🔥 274 `  - Flutter plugin for ARCore SDK, Android platform to build new augmented reality experiences ` 📝 6 days ago`
...
* [WebView](https://github.com/dart-flitter/flutter_webview_plugin) ` 🔥 1.3k `  - Community WebView Plugin - Allows Flutter to communicate with a native WebView. ` 📝 19 days ago `
...
* [Geolocator](https://github.com/baseflow/flutter-geolocator) ` 🔥 801 `  - Android and iOS Geolocation plugin for Flutter ` 📝 5 days ago `
...
* [Downloader](https://github.com/hnvn/flutter_downloader) ` 🔥 570 `  - Flutter Downloader - A plugin for creating and managing download tasks. Supports iOS and Android. Maintainer: @hnvn ` 📝 14 days ago `
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ` 🔥 567 `  - File picker plugin for Flutter, compatible with both iOS & Android and desktop (go-flutter). ` 📝 17 days ago `
...
* #### Scanner [🔝](#readme)
    ...
    * [QR Code Reader](https://github.com/villela/flutter_qrcode_reader) ` 🔥 214 `  - Flutter qrcode reader ` 📝 12 days ago`
...
* #### Bluetooth / NFC / Beacon [🔝](#readme)
    ...
    * [Reactive Ble](https://github.com/PhilipsHue/flutter_reactive_ble) ` 🔥 185 `  - Flutter library that handles BLE operations for multiple devices. ` 📝 13 days ago`
...
* [OneSignal](https://github.com/OneSignal/OneSignal-Flutter-SDK) ` 🔥 446 `  - OneSignal is a free push notification service for mobile apps. This plugin makes it easy to integrate your flutter app with OneSignal ` 📝 7 days ago `
...
* #### Standard [🔝](#readme)
    ...
    * [RiverPod](https://github.com/rrousselGit/river_pod) ` 🔥 1.6k `  - A simple way to access state while robust and testable. ` 📝 3 days ago`
...
* [Form Builder](https://github.com/danvick/flutter_form_builder) ` 🔥 778 `  - Simple form maker for Flutter Framework ` 📝 23 days ago `
...
* [Ferry](https://github.com/gql-dart/ferry) ` 🔥 194 `  - Stream-based strongly typed GraphQL client for Dart ` 📝 2 days ago `
...
* [Sequence Animation](https://github.com/Norbert515/flutter_sequence_animation) ` 🔥 306 `  - Orchestrate multiple animations with ease. ` 📝 6 days ago `
...
* [Funvas](https://github.com/creativecreatorormaybenot/funvas) ` 🔥 231 `  - Fun canvas animations in Flutter based on time and math functions. ` 📝 3 days ago `
* [Animate Do](https://pub.dev/packages/animate_do)   
  
## Testing [🔝](#readme)

* [Flutter Gherkin](https://github.com/jonsamwell/flutter_gherkin) ` 🔥 131 `  - A Gherkin parsers and runner for Dart and Flutter which is very similar to cucumber ` 📝 18 days ago `
  
## Web [🔝](#readme)

* [Responsive Framework](https://github.com/Codelessly/ResponsiveFramework) ` 🔥 533 `  - Easily make Flutter apps responsive. Automatically adapt UI to different screen sizes. Responsiveness made simple. Demo: https://gallery.codelessly.com/flutterwebsites/minimal/ ` 📝 5 days ago `
...
* [Graphx](https://github.com/roipeker/graphx) ` 🔥 246 `  - GraphX lib for Flutter ` 📝 11 days ago `
...
* #### Open source games [🔝](#readme)
    ...
    * [Slide Puzzle](https://github.com/kevmoo/slide_puzzle) ` 🔥 128 `  - The classic slide (15) puzzle in Dart and Flutter ` 📝 11 days ago`
...
* [Flutter Team Samples](https://github.com/flutter/samples) ` 🔥 9.9k `  - A collection of Flutter examples and demos. ` 📝 2 days ago `
...
* [Fwitter](https://github.com/TheAlphamerc/flutter_twitter_clone) ` 🔥 1.3k `  - Fully functional Twitter clone built in flutter framework using Firebase realtime database and storage ` 📝 8 days ago `
...
* [AuthPass](https://github.com/authpass/authpass) ` 🔥 661 `  - AuthPass - Password Manager based on Flutter for all platforms. Keepass 2.x (kdbx 3.x) compatible. ` 📝 19 days ago `
...
* [Harpy](https://github.com/robertodoering/harpy) ` 🔥 430 `  - A Twitter app built with Flutter ` 📝 3 days ago `
...
* [Very Good Cli](https://github.com/VeryGoodOpenSource/very_good_cli) ` 🔥 778 `  - A Very Good Command Line Interface for Dart created by Very Good Ventures ` 📝 14 days ago `
* [FlutterGen](https://github.com/FlutterGen/flutter_gen) ` 🔥 644 `  - The Flutter code generator for your assets, fonts, colors, … — Get rid of all String-based APIs. ` 📝 13 days ago `
...
* [Raspberry Pi Embedder](https://github.com/ardera/flutter-pi) ` 🔥 606 `  - A light-weight Flutter Engine Embedder for Raspberry Pi that runs without X. ` 📝 3 days ago `
* [bitsdojo_window](https://github.com/bitsdojo/bitsdojo_window) ` 🔥 193 `  - A Flutter package that makes it easy to customize and work with your Flutter desktop app window. ` 📝 3 days ago `
