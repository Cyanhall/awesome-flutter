...
* [Roadmap to Flutter Development](https://github.com/olexale/flutter_roadmap) ` 🔥 2k `  - Highly Subjective Roadmap to Flutter Development ` 📝 16 days ago `
...
* [Official Gallery](https://github.com/flutter/gallery) ` 🔥 2.5k `  - Flutter Gallery is a resource to help developers evaluate and use Flutter ` 📝 11 days ago `
* [Flutter Catalog](https://github.com/X-Wei/flutter_catalog) ` 🔥 1.5k `  - An app showcasing Flutter components, with side-by-side source code view. ` 📝 8 days ago `
...
* [Direct Select](https://github.com/LanarsInc/direct-select-flutter) ` 🔥 400 `  - DirectSelect is a selection widget with an ethereal, full-screen modal popup displaying the available choices when the widget is interact with. https://dribbble.com/shots/3876250-DirectSelect-Dropdown-ux ` 📝 21 days ago `
...
* [Card Settings](https://github.com/codegrue/card_settings) ` 🔥 279 `  - A flutter package for building card based forms. ` 📝 13 days ago `
...
* [Scratcher](https://github.com/vintage/scratcher) ` 🔥 250 `  - Scratch card widget which temporarily hides content from user. ` 📝 20 days ago `
...
* #### Sliders [🔝](#readme)
    ...
    * [RangeSlider](https://github.com/boeledi/RangeSlider) ` 🔥 270 `  - RangeSlider Widget for Flutter ` 📝 3 months ago`
...
* #### UI Helpers [🔝](#readme)
    ...
    * [ShowCaseView](https://github.com/simformsolutions/flutter_showcaseview) ` 🔥 552 `  - Flutter plugin that allows you to showcase your features on iOS and Android. ` 📝 6 days ago`
...
* #### Material Design [🔝](#readme)
    ...
    * [Slidable](https://github.com/letsar/flutter_slidable) ` 🔥 1.8k `  - A Flutter implementation of slidable list item with directional slide actions. ` 📝 25 days ago`
...
* #### Effect [🔝](#readme)
    ...
    * [Liquid Swipe](https://github.com/iamSahdeep/liquid_swipe_flutter) ` 🔥 739 `  - A flutter based liquid swipe ` 📝 9 days ago`
...
* #### Login [🔝](#readme)
    ...
    * [Flutter Login](https://github.com/NearHuscarl/flutter_login) ` 🔥 769 `  - Provides login screen with login/signup functionalities to help speed up development ` 📝 4 days ago`
...
* [Multi Image Picker](https://github.com/Sh1d0w/multi_image_picker) ` 🔥 903 `  - Flutter plugin that allows you to display multi image picker on iOS and Android. ` 📝 23 days ago `
...
* [Crop](https://github.com/xclud/flutter_crop) ` 🔥 123 `  - Crop any widget/image in Android, iOS, Web and Desktop with fancy and customizable UI, in pure Dart code. ` 📝 7 days ago `
* [Bitmap](https://github.com/renancaraujo/bitmap) ` 🔥 109 `  - A Flutter package for manipulating bitmaps ` 📝 3 months ago `
  
* #### Image Picker [🔝](#readme)

    * [WeChat Assets Picker](https://github.com/fluttercandies/flutter_wechat_assets_picker) ` 🔥 566 `  - An assets picker in WeChat style, support multi assets picking. ` 📝 10 days ago`
...
* [FL Chart](https://github.com/imaNNeoFighT/fl_chart) ` 🔥 3.1k `  - A powerful Flutter chart library, currently supporting Line Chart, Bar Chart, Pie Chart, Scatter Chart and Radar Chart. ` 📝 11 days ago `
...
* [Flutter AppAuth](https://github.com/MaikuB/flutter_appauth) ` 🔥 154 `  - A Flutter wrapper for AppAuth iOS and Android SDKs ` 📝 3 days ago `
...
* [Parsed Text](https://github.com/fayeed/flutter_parsed_text) ` 🔥 157 `  - A Flutter package to parse text and make them into linkified text widget ` 📝 6 days ago `
* [Code Field](https://github.com/BertrandBev/code_field) ` 🔥 52 `  - A customizable code text field supporting syntax highlighting ` 📝 3 days ago `
...
* [attranslate](https://github.com/fkirc/attranslate) ` 🔥 206 `  - Semi-automated Text Translator for Websites and Apps ` 📝 3 days ago `
...
* #### Audio [🔝](#readme)
    ...
    * [Flutter Sound](https://github.com/dooboolab/flutter_sound) ` 🔥 560 `  - Flutter plugin for sound. Audio recorder and player. ` 📝 15 days ago`
...
* #### Video [🔝](#readme)
    ...
    * [CamerAwesome](https://github.com/Apparence-io/camera_awesome) ` 🔥 222 `  - A flutter plugin to handle Android / iOS camera ` 📝 4 days ago`
    * [Video Trimmer](https://github.com/sbis04/video_trimmer) ` 🔥 208 `  - Flutter video trimmer package ` 📝 11 days ago`
...
* [Square In-App Payments SDK](https://github.com/square/in-app-payments-flutter-plugin) ` 🔥 267 `  - Flutter Plugin for Square In-App Payments SDK ` 📝 4 days ago `
* [Facebook Audience Network](https://github.com/dreamsoftin/facebook_audience_network) ` 🔥 127 `  - Flutter Facebook Audience Network ` 📝 8 days ago `
...
* [ActingWeb First_App](https://github.com/gregertw/actingweb_firstapp) ` 🔥 247 `  - Starter app for Flutter that includes many different production app features; some not typically included in demo apps. ` 📝 a day ago `
...
* [GitTouch](https://github.com/pd4d10/git-touch) ` 🔥 759 `  - An open-source app for GitHub, GitLab, Bitbucket, Gitea, and Gitee(码云), built with Flutter ` 📝 7 days ago `
...
* #### Augmented Reality [🔝](#readme)
    ...
    * [ARKit Plugin](https://github.com/olexale/arkit_flutter_plugin) ` 🔥 540 `  - ARKit Flutter Plugin ` 📝 2 days ago`
    * [ARCore Plugin](https://github.com/giandifra/arcore_flutter_plugin) ` 🔥 273 `  - Flutter plugin for ARCore SDK, Android platform to build new augmented reality experiences ` 📝 23 days ago`
...
* [WebView](https://github.com/dart-flitter/flutter_webview_plugin) ` 🔥 1.3k `  - Community WebView Plugin - Allows Flutter to communicate with a native WebView. ` 📝 14 days ago `
...
* [Location](https://github.com/Lyokone/flutterlocation) ` 🔥 744 `  - A Flutter plugin to easily handle realtime location in iOS and Android. Provides settings for optimizing performance or battery. ` 📝 a day ago `
* [Downloader](https://github.com/hnvn/flutter_downloader) ` 🔥 567 `  - Flutter Downloader - A plugin for creating and managing download tasks. Supports iOS and Android. Maintainer: @hnvn ` 📝 9 days ago `
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ` 🔥 565 `  - File picker plugin for Flutter, compatible with both iOS & Android and desktop (go-flutter). ` 📝 12 days ago `
...
* #### Scanner [🔝](#readme)
    ...
    * [QR Code Reader](https://github.com/villela/flutter_qrcode_reader) ` 🔥 213 `  - Flutter qrcode reader ` 📝 7 days ago`
...
* #### Bluetooth / NFC / Beacon [🔝](#readme)
    ...
    * [Reactive Ble](https://github.com/PhilipsHue/flutter_reactive_ble) ` 🔥 185 `  - Flutter library that handles BLE operations for multiple devices. ` 📝 8 days ago`
...
* [OneSignal](https://github.com/OneSignal/OneSignal-Flutter-SDK) ` 🔥 446 `  - OneSignal is a free push notification service for mobile apps. This plugin makes it easy to integrate your flutter app with OneSignal ` 📝 2 days ago `
...
* [Form Builder](https://github.com/danvick/flutter_form_builder) ` 🔥 777 `  - Simple form maker for Flutter Framework ` 📝 18 days ago `
...
* [Ferry](https://github.com/gql-dart/ferry) ` 🔥 193 `  - Stream-based strongly typed GraphQL client for Dart ` 📝 5 days ago `
...
* [Funvas](https://github.com/creativecreatorormaybenot/funvas) ` 🔥 222 `  - Fun canvas animations in Flutter based on time and math functions. ` 📝 a day ago `
* [Animate Do](https://pub.dev/packages/animate_do)   
  
## Testing [🔝](#readme)

* [Flutter Gherkin](https://github.com/jonsamwell/flutter_gherkin) ` 🔥 130 `  - A Gherkin parsers and runner for Dart and Flutter which is very similar to cucumber ` 📝 13 days ago `
...
* [Graphx](https://github.com/roipeker/graphx) ` 🔥 244 `  - GraphX lib for Flutter ` 📝 6 days ago `
...
* #### Open source games [🔝](#readme)
    ...
    * [Slide Puzzle](https://github.com/kevmoo/slide_puzzle) ` 🔥 128 `  - The classic slide (15) puzzle in Dart and Flutter ` 📝 6 days ago`
...
* [Pokedex](https://github.com/scitbiz/flutter_pokedex) ` 🔥 1.1k `  - Pokedex app built with Flutter (with lots of animations) using Clean Architecture ` 📝 a day ago `
...
* [AuthPass](https://github.com/authpass/authpass) ` 🔥 659 `  - AuthPass - Password Manager based on Flutter for all platforms. Keepass 2.x (kdbx 3.x) compatible. ` 📝 14 days ago `
...
* [Harpy](https://github.com/robertodoering/harpy) ` 🔥 426 `  - A Twitter app built with Flutter ` 📝 a day ago `
...
* [Very Good Cli](https://github.com/VeryGoodOpenSource/very_good_cli) ` 🔥 775 `  - A Very Good Command Line Interface for Dart created by Very Good Ventures ` 📝 9 days ago `
* [FlutterGen](https://github.com/FlutterGen/flutter_gen) ` 🔥 640 `  - The Flutter code generator for your assets, fonts, colors, … — Get rid of all String-based APIs. ` 📝 8 days ago `
